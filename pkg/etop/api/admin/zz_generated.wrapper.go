...
type AddShippingFeeEndpoint struct {
	*api.AddShippingFeeRequest
	Result  *cm.UpdatedResponse
	Context claims.AdminClaim
}

func (s wrapFulfillmentService) AddShippingFee(ctx context.Context, req *api.AddShippingFeeRequest) (resp *cm.UpdatedResponse, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Fulfillment/AddShippingFee"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
	...
	session = sessionQuery.Result
	query := &AddShippingFeeEndpoint{AddShippingFeeRequest: req}
	if session != nil {
		query.Context.Claim = session.Claim
	}
	query.Context.IsEtopAdmin = session.IsEtopAdmin
	...
	query.Context.Permissions = session.Permissions
	ctx = bus.NewRootContext(ctx)
	err = s.s().AddShippingFee(ctx, query)
	resp = query.Result
	if err != nil {
		return nil, err
	}
...
type UpdateFulfillmentInfoEndpoint struct {
	*api.UpdateFulfillmentInfoRequest
	Result  *cm.UpdatedResponse
	Context claims.AdminClaim
}

func (s wrapFulfillmentService) UpdateFulfillmentInfo(ctx context.Context, req *api.UpdateFulfillmentInfoRequest) (resp *cm.UpdatedResponse, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Fulfillment/UpdateFulfillmentInfo"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
	...
	session = sessionQuery.Result
	query := &UpdateFulfillmentInfoEndpoint{UpdateFulfillmentInfoRequest: req}
	if session != nil {
		query.Context.Claim = session.Claim
	}
	query.Context.IsEtopAdmin = session.IsEtopAdmin
	...
	query.Context.Permissions = session.Permissions
	ctx = bus.NewRootContext(ctx)
	err = s.s().UpdateFulfillmentInfo(ctx, query)
	resp = query.Result
	if err != nil {
		return nil, err
	}
...
func (s wrapUserService) GetUser(ctx context.Context, req *cm.IDRequest) (resp *etop.User, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.User/GetUser"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
	...
	session = sessionQuery.Result
	query := &GetUserEndpoint{IDRequest: req}
	if session != nil {
		query.Context.Claim = session.Claim
	}
	query.Context.IsEtopAdmin = session.IsEtopAdmin
...
type GetUsersEndpoint struct {
	*api.GetUsersRequest
	Result  *api.UserResponse
	Context claims.AdminClaim
}

func (s wrapUserService) GetUsers(ctx context.Context, req *api.GetUsersRequest) (resp *api.UserResponse, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.User/GetUsers"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
	...
	session = sessionQuery.Result
	query := &GetUsersEndpoint{GetUsersRequest: req}
	if session != nil {
		query.Context.Claim = session.Claim
	}
	query.Context.IsEtopAdmin = session.IsEtopAdmin
...
type GetUsersByIDsEndpoint struct {
	*cm.IDsRequest
	Result  *api.UserResponse
	Context claims.AdminClaim
}

func (s wrapUserService) GetUsersByIDs(ctx context.Context, req *cm.IDsRequest) (resp *api.UserResponse, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.User/GetUsersByIDs"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
	...
	session = sessionQuery.Result
	query := &GetUsersByIDsEndpoint{IDsRequest: req}
	if session != nil {
		query.Context.Claim = session.Claim
	}
	query.Context.IsEtopAdmin = session.IsEtopAdmin
	...
	query.Context.Permissions = session.Permissions
	ctx = bus.NewRootContext(ctx)
	err = s.s().GetUsersByIDs(ctx, query)
	resp = query.Result
	if err != nil {
		return nil, err
	}
