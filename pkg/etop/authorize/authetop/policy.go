...
const Policy auth.Policy = authcommon.CommonPolicy + `
	...
	p, shop/call_session:delete, admin, owner, analyst, salesman, accountant, purchasing_management, inventory_management, staff_management, telecom_customerservice
