...
func GetSupplier(ctx context.Context, query *model.GetSupplierQuery) error {
...
func GetSupplierExtended(ctx context.Context, query *model.GetSupplierExtendedQuery) error {
...
func GetSupplierWithPermission(ctx context.Context, query *model.GetSupplierWithPermissionQuery) error {
...
func GetSuppliers(ctx context.Context, query *model.GetSuppliersQuery) error {
	s := x.Table("supplier")
	if query.Status != nil {
...
func GetSupplierExtendeds(ctx context.Context, query *model.GetSupplierExtendedsQuery) error {
	s := x.Table("supplier")
	if query.Status != nil {
		s = s.Where("status = ?", query.Status)
	}
...
func GetSuppliersWithShipFromAddress(ctx context.Context, query *model.GetSuppliersWithShipFromAddressQuery) error {
	return x.In("s.id", query.IDs).
		Find((*model.SupplierShipFromAddresses)(&query.Result.Suppliers))
}

func GetAllSuppliers(ctx context.Context, query *model.GetAllSuppliersQuery) error {
	err := x.Find((*model.Suppliers)(&query.Result))
	return err
}

func UpdatePriceRules(ctx context.Context, cmd *model.UpdatePriceRulesCommand) error {
	if cmd.SupplierID == 0 {
...
func UpdateKiotvietAccessToken(ctx context.Context, cmd *model.UpdateKiotvietAccessTokenCommand) error {
...
func SyncUpdateCategories(ctx context.Context, cmd *model.SyncUpdateCategoriesCommand) error {
	if cmd.SourceID == 0 {
...
func SyncUpdateProducts(ctx context.Context, cmd *model.SyncUpdateProductsCommand) error {
	if cmd.SourceID == 0 {
		return cm.Error(cm.InvalidArgument, "Missing SourceID", nil)
	}
	...
	for _, item := range cmd.Data {
		...
		if exists, err := x.
			...
			err := x.InTransaction(func(x Qx) error {
				prodCmd := &model.SyncGetOrCreateProductCommand{
...
func syncGetOrCreateProduct(ctx context.Context, x Qx, cmd *model.SyncGetOrCreateProductCommand) error {
	return cm.ErrTODO
}

func SyncUpdateProductsQuantity(ctx context.Context, cmd *model.SyncUpdateProductsQuantityCommand) error {
...
func UpdateSupplier(ctx context.Context, cmd *model.UpdateSupplierCommand) error {
