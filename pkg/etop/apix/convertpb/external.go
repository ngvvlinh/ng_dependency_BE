...
func PbOrder(m *ordermodel.Order) *external.Order {
	res := &external.Order{
		...
		TotalItems:                cmapi.PbPtrInt32(m.TotalItems),
		BasketValue:               cmapi.PbPtrInt32(m.BasketValue),
		OrderDiscount:             cmapi.PbPtrInt32(m.OrderDiscount),
		TotalDiscount:             cmapi.PbPtrInt32(m.TotalDiscount),
		TotalFee:                  cmapi.PbPtrInt32(m.GetTotalFee()),
		FeeLines:                  convertpb.PbOrderFeeLines(m.GetFeeLines()),
		TotalAmount:               cmapi.PbPtrInt32(m.TotalAmount),
...
func PbOrderShipping(m *ordermodel.Order) *external.OrderShipping {
	...
	return &external.OrderShipping{
		...
		ShippingServiceFee:  cmapi.PbPtrInt32(shipping.ExternalShippingFee),
		...
		CodAmount:           cmapi.PbPtrInt32(m.ShopCOD),
		GrossWeight:         cmapi.PbPtrInt32(m.TotalWeight),
		Length:              cmapi.PbPtrInt32(shipping.Length),
		Width:               cmapi.PbPtrInt32(shipping.Width),
		Height:              cmapi.PbPtrInt32(shipping.Height),
		ChargeableWeight:    cmapi.PbPtrInt32(m.TotalWeight),
	}
}
...
func PbOrderHistory(order ordermodel.OrderHistory) *external.Order {
	...
	res.FeeLines = convertpb.PbOrderFeeLines(ordermodel.GetFeeLinesWithFallback(feeLines, res.TotalDiscount, order.ShopShippingFee().Int32()))
	return res
}
...
func PbOrderLine(m *ordermodel.OrderLine) *external.OrderLine {
	...
	return &external.OrderLine{
		...
		PaymentPrice: cmapi.PbPtrInt32(m.PaymentPrice),
		ImageUrl:     m.ImageURL,
...
func PbFulfillment(m *shipmodel.Fulfillment) *external.Fulfillment {
	return &external.Fulfillment{
		...
		ShippingServiceFee:       cmapi.PbPtrInt32(m.ShippingServiceFee),
		ActualShippingServiceFee: cmapi.PbPtrInt32(m.ShippingFeeShop),
		...
		Status:                   convertpb.Pb5PtrStatus(m.Status),
		CodAmount:                cmapi.PbPtrInt32(m.OriginalCODAmount),
		ActualCodAmount:          cmapi.PbPtrInt32(m.TotalCODAmount),
		ChargeableWeight:         cmapi.PbPtrInt32(m.TotalWeight),
