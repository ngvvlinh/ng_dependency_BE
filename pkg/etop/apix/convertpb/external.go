...
func PbFbExternalComment(fbcomment *fbmessaging.FbExternalComment) *exttypes.FbExternalComment {
	...
	return &exttypes.FbExternalComment{
		...
		ExternalCreatedTime:  time.Time(fbcomment.ExternalCreatedTime),
...
func PbFbExternalCommentEvent(fbcomment *fbmessaging.FbExternalComment, op string) *pgevent.PgEventComment {
	if fbcomment == nil {
		return nil
	}
	return &pgevent.PgEventComment{
		Op:             op,
...
func PbFbExternalConversationEvent(fbConversation *fbmessaging.FbExternalConversation, op string) *pgevent.PgEventConversation {
	if fbConversation == nil {
		return nil
	}
	return &pgevent.PgEventConversation{
...
func PbFbExternalMessageEvent(fbmessage *fbmessaging.FbExternalMessage, op string) *pgevent.PgEventMessage {
	if fbmessage == nil {
		return nil
	}
	return &pgevent.PgEventMessage{
		Op:             op,
