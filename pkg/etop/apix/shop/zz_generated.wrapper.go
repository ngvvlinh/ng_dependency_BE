...
func (s wrapCustomerService) ListCustomers(ctx context.Context, req *externaltypes.ListCustomersRequest) (resp *externaltypes.CustomersResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.Customer/ListCustomers"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerAddressService) CreateAddress(ctx context.Context, req *externaltypes.CreateCustomerAddressRequest) (resp *externaltypes.CustomerAddress, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerAddress/CreateAddress"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerAddressService) DeleteAddress(ctx context.Context, req *cm.IDRequest) (resp *cm.Empty, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerAddress/DeleteAddress"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerAddressService) GetAddress(ctx context.Context, req *externaltypes.OrderIDRequest) (resp *externaltypes.CustomerAddress, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerAddress/GetAddress"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerAddressService) ListAddresses(ctx context.Context, req *externaltypes.ListCustomerAddressesRequest) (resp *externaltypes.CustomerAddressesResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerAddress/ListAddresses"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerAddressService) UpdateAddress(ctx context.Context, req *externaltypes.UpdateCustomerAddressRequest) (resp *externaltypes.CustomerAddress, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerAddress/UpdateAddress"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerGroupService) CreateGroup(ctx context.Context, req *externaltypes.CreateCustomerGroupRequest) (resp *externaltypes.CustomerGroup, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerGroup/CreateGroup"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerGroupService) DeleteGroup(ctx context.Context, req *cm.IDRequest) (resp *cm.Empty, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerGroup/DeleteGroup"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerGroupService) GetGroup(ctx context.Context, req *cm.IDRequest) (resp *externaltypes.CustomerGroup, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerGroup/GetGroup"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerGroupService) ListGroups(ctx context.Context, req *externaltypes.ListCustomerGroupsRequest) (resp *externaltypes.CustomerGroupsResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerGroup/ListGroups"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerGroupService) UpdateGroup(ctx context.Context, req *externaltypes.UpdateCustomerGroupRequest) (resp *externaltypes.CustomerGroup, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerGroup/UpdateGroup"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerGroupRelationshipService) CreateRelationship(ctx context.Context, req *externaltypes.AddCustomerRequest) (resp *cm.Empty, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerGroupRelationship/CreateRelationship"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerGroupRelationshipService) DeleteRelationship(ctx context.Context, req *externaltypes.RemoveCustomerRequest) (resp *cm.Empty, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerGroupRelationship/DeleteRelationship"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapCustomerGroupRelationshipService) ListRelationships(ctx context.Context, req *externaltypes.ListCustomerGroupRelationshipsRequest) (resp *externaltypes.CustomerGroupRelationshipsResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.CustomerGroupRelationship/ListRelationships"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapFulfillmentService) ListFulfillments(ctx context.Context, req *externaltypes.ListFulfillmentsRequest) (resp *externaltypes.FulfillmentsResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.Fulfillment/ListFulfillments"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapInventoryService) ListInventoryLevels(ctx context.Context, req *externaltypes.ListInventoryLevelsRequest) (resp *externaltypes.InventoryLevelsResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.Inventory/ListInventoryLevels"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapOrderService) ListOrders(ctx context.Context, req *externaltypes.ListOrdersRequest) (resp *externaltypes.OrdersResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.Order/ListOrders"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapProductService) DeleteProduct(ctx context.Context, req *externaltypes.GetProductRequest) (resp *cm.Empty, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.Product/DeleteProduct"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapProductService) ListProducts(ctx context.Context, req *externaltypes.ListProductsRequest) (resp *externaltypes.ShopProductsResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.Product/ListProducts"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapProductCollectionService) CreateCollection(ctx context.Context, req *externaltypes.CreateCollectionRequest) (resp *externaltypes.ProductCollection, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.ProductCollection/CreateCollection"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapProductCollectionService) DeleteCollection(ctx context.Context, req *externaltypes.GetCollectionRequest) (resp *cm.Empty, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.ProductCollection/DeleteCollection"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapProductCollectionService) GetCollection(ctx context.Context, req *externaltypes.GetCollectionRequest) (resp *externaltypes.ProductCollection, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.ProductCollection/GetCollection"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapProductCollectionService) ListCollections(ctx context.Context, req *externaltypes.ListCollectionsRequest) (resp *externaltypes.ProductCollectionsResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.ProductCollection/ListCollections"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapProductCollectionService) UpdateCollection(ctx context.Context, req *externaltypes.UpdateCollectionRequest) (resp *externaltypes.ProductCollection, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.ProductCollection/UpdateCollection"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapProductCollectionRelationshipService) CreateRelationship(ctx context.Context, req *externaltypes.CreateProductCollectionRelationshipRequest) (resp *cm.Empty, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.ProductCollectionRelationship/CreateRelationship"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapProductCollectionRelationshipService) DeleteRelationship(ctx context.Context, req *externaltypes.RemoveProductCollectionRequest) (resp *cm.Empty, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.ProductCollectionRelationship/DeleteRelationship"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapProductCollectionRelationshipService) ListRelationships(ctx context.Context, req *externaltypes.ListProductCollectionRelationshipsRequest) (resp *externaltypes.ProductCollectionRelationshipsResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.ProductCollectionRelationship/ListRelationships"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapVariantService) CreateVariant(ctx context.Context, req *externaltypes.CreateVariantRequest) (resp *externaltypes.ShopVariant, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.Variant/CreateVariant"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapVariantService) DeleteVariant(ctx context.Context, req *externaltypes.GetVariantRequest) (resp *cm.Empty, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.Variant/DeleteVariant"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapVariantService) GetVariant(ctx context.Context, req *externaltypes.GetVariantRequest) (resp *externaltypes.ShopVariant, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.Variant/GetVariant"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapVariantService) ListVariants(ctx context.Context, req *externaltypes.ListVariantsRequest) (resp *externaltypes.ShopVariantsResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.Variant/ListVariants"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s wrapVariantService) UpdateVariant(ctx context.Context, req *externaltypes.UpdateVariantRequest) (resp *externaltypes.ShopVariant, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "shop.Variant/UpdateVariant"
	defer func() {
		recovered := recover()
		err = cmwrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
