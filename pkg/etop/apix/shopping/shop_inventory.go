...
func (s *Shopping) ListInventoryLevels(ctx context.Context, shopID dot.ID, request *externaltypes.ListInventoryLevelsRequest) (*externaltypes.InventoryLevelsResponse, error) {
	var IDs []dot.ID
