...
func (ft OrderFilters) ByExternalConfirm(ExternalConfirm model.Status3) *sq.ColumnFilter {
	return &sq.ColumnFilter{
		Prefix: ft.prefix,
...
func (ft OrderFilters) ByExternalConfirmPtr(ExternalConfirm *model.Status3) *sq.ColumnFilterPtr {
	return &sq.ColumnFilterPtr{
		Prefix: ft.prefix,
		Column: "external_confirm",
		Value:  ExternalConfirm,
...
func (ft OrderExternalCreateOrderFilters) ByExternalConfirm(ExternalConfirm model.Status3) *sq.ColumnFilter {
	return &sq.ColumnFilter{
		Prefix: ft.prefix,
		Column: "external_confirm",
		Value:  ExternalConfirm,
...
func (ft OrderExternalCreateOrderFilters) ByExternalConfirmPtr(ExternalConfirm *model.Status3) *sq.ColumnFilterPtr {
	return &sq.ColumnFilterPtr{
		Prefix: ft.prefix,
		Column: "external_confirm",
		Value:  ExternalConfirm,
...
func (ft OrderExternalCreateOrderFilters) ByOrderSourceType(OrderSourceType model.OrderSourceType) *sq.ColumnFilter {
	return &sq.ColumnFilter{
		Prefix: ft.prefix,
		Column: "order_source_type",
		Value:  OrderSourceType,
...
func (ft OrderExternalCreateOrderFilters) ByOrderSourceTypePtr(OrderSourceType *model.OrderSourceType) *sq.ColumnFilterPtr {
	return &sq.ColumnFilterPtr{
		Prefix: ft.prefix,
		Column: "order_source_type",
		Value:  OrderSourceType,
...
func (ft OrderExternalUpdateOrderFilters) ByExternalConfirm(ExternalConfirm model.Status3) *sq.ColumnFilter {
	return &sq.ColumnFilter{
		Prefix: ft.prefix,
		Column: "external_confirm",
		Value:  ExternalConfirm,
...
func (ft OrderExternalUpdateOrderFilters) ByExternalConfirmPtr(ExternalConfirm *model.Status3) *sq.ColumnFilterPtr {
	return &sq.ColumnFilterPtr{
		Prefix: ft.prefix,
		Column: "external_confirm",
		Value:  ExternalConfirm,
...
func (ft OrderLineFilters) BySupplierConfirm(SupplierConfirm model.Status3) *sq.ColumnFilter {
	return &sq.ColumnFilter{
		Prefix: ft.prefix,
...
func (ft OrderLineFilters) BySupplierConfirmPtr(SupplierConfirm *model.Status3) *sq.ColumnFilterPtr {
	return &sq.ColumnFilterPtr{
		Prefix: ft.prefix,
		Column: "supplier_confirm",
		Value:  SupplierConfirm,
