...
type SingleSender struct {
	...
	lastItems *whtypes.MessageCollector
	items     *whtypes.MessageCollector
...
func (s *SingleSender) storeToDatabase(callbackID int64, mc *whtypes.MessageCollector, states *WebhookStatesError) error {
	// TODO: refactor
