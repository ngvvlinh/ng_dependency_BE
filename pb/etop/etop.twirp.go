...
// =================================
// InvitationService Protobuf Client
// =================================

type invitationServiceProtobufClient struct {
	client HTTPClient
	urls   [4]string
}

// NewInvitationServiceProtobufClient creates a Protobuf client that implements the InvitationService interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewInvitationServiceProtobufClient(addr string, client HTTPClient) InvitationService {
	prefix := urlBase(addr) + InvitationServicePathPrefix
	urls := [4]string{
		prefix + "AcceptInvitation",
		prefix + "RejectInvitation",
		prefix + "GetInvitationByToken",
		prefix + "GetInvitations",
	}
	if httpClient, ok := client.(*http.Client); ok {
		return &invitationServiceProtobufClient{
			client: withoutRedirects(httpClient),
			urls:   urls,
		}
	}
...
func (c *invitationServiceProtobufClient) AcceptInvitation(ctx context.Context, in *AcceptInvitationRequest) (*cm.UpdatedResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "etop")
	ctx = ctxsetters.WithServiceName(ctx, "Invitation")
...
func (c *invitationServiceProtobufClient) RejectInvitation(ctx context.Context, in *RejectInvitationRequest) (*cm.UpdatedResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "etop")
	ctx = ctxsetters.WithServiceName(ctx, "Invitation")
...
func (c *invitationServiceProtobufClient) GetInvitationByToken(ctx context.Context, in *GetInvitationByTokenRequest) (*Invitation, error) {
	ctx = ctxsetters.WithPackageName(ctx, "etop")
	ctx = ctxsetters.WithServiceName(ctx, "Invitation")
	ctx = ctxsetters.WithMethodName(ctx, "GetInvitationByToken")
	out := new(Invitation)
	err := doProtobufRequest(ctx, c.client, c.urls[2], in, out)
	if err != nil {
		return nil, err
...
func (c *invitationServiceProtobufClient) GetInvitations(ctx context.Context, in *GetInvitationsRequest) (*InvitationsResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "etop")
	ctx = ctxsetters.WithServiceName(ctx, "Invitation")
	ctx = ctxsetters.WithMethodName(ctx, "GetInvitations")
...
// =============================
// InvitationService JSON Client
// =============================

type invitationServiceJSONClient struct {
	client HTTPClient
	urls   [4]string
}

// NewInvitationServiceJSONClient creates a JSON client that implements the InvitationService interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewInvitationServiceJSONClient(addr string, client HTTPClient) InvitationService {
	prefix := urlBase(addr) + InvitationServicePathPrefix
	urls := [4]string{
		prefix + "AcceptInvitation",
		prefix + "RejectInvitation",
	...
	if httpClient, ok := client.(*http.Client); ok {
		return &invitationServiceJSONClient{
			client: withoutRedirects(httpClient),
			urls:   urls,
		}
	}
...
func (c *invitationServiceJSONClient) AcceptInvitation(ctx context.Context, in *AcceptInvitationRequest) (*cm.UpdatedResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "etop")
	ctx = ctxsetters.WithServiceName(ctx, "Invitation")
	ctx = ctxsetters.WithMethodName(ctx, "AcceptInvitation")
	out := new(cm.UpdatedResponse)
...
func (c *invitationServiceJSONClient) RejectInvitation(ctx context.Context, in *RejectInvitationRequest) (*cm.UpdatedResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "etop")
	ctx = ctxsetters.WithServiceName(ctx, "Invitation")
	ctx = ctxsetters.WithMethodName(ctx, "RejectInvitation")
	out := new(cm.UpdatedResponse)
...
func (c *invitationServiceJSONClient) GetInvitationByToken(ctx context.Context, in *GetInvitationByTokenRequest) (*Invitation, error) {
	ctx = ctxsetters.WithPackageName(ctx, "etop")
	ctx = ctxsetters.WithServiceName(ctx, "Invitation")
	ctx = ctxsetters.WithMethodName(ctx, "GetInvitationByToken")
	out := new(Invitation)
...
func (c *invitationServiceJSONClient) GetInvitations(ctx context.Context, in *GetInvitationsRequest) (*InvitationsResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "etop")
	ctx = ctxsetters.WithServiceName(ctx, "Invitation")
	ctx = ctxsetters.WithMethodName(ctx, "GetInvitations")
	out := new(InvitationsResponse)
...
// ================================
// InvitationService Server Handler
// ================================
...
func NewInvitationServiceServer(svc InvitationService, hooks *twirp.ServerHooks) TwirpServer {
...
// writeError writes an HTTP response with a valid Twirp error format, and triggers hooks.
// If err is not a twirp.Error, it will get wrapped with twirp.InternalErrorWith(err)
func (s *invitationServiceServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// InvitationServicePathPrefix is used for all URL paths on a twirp InvitationService server.
// Requests are always: POST InvitationServicePathPrefix/method
// It can be used in an HTTP mux to route twirp requests along with non-twirp requests on other routes.
const InvitationServicePathPrefix = "/api/etop.Invitation/"
...
func (s *invitationServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/api/etop.Invitation/AcceptInvitation":
		s.serveAcceptInvitation(ctx, resp, req)
		return
	case "/api/etop.Invitation/RejectInvitation":
		s.serveRejectInvitation(ctx, resp, req)
		return
	case "/api/etop.Invitation/GetInvitationByToken":
		s.serveGetInvitationByToken(ctx, resp, req)
		return
	case "/api/etop.Invitation/GetInvitations":
		s.serveGetInvitations(ctx, resp, req)
		return
	default:
		msg := fmt.Sprintf("no handler for path %q", req.URL.Path)
		err = badRouteError(msg, req.Method, req.URL.Path)
...
func (s *invitationServiceServer) serveAcceptInvitation(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *invitationServiceServer) serveAcceptInvitationJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "AcceptInvitation")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.InvitationService.AcceptInvitation(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *cm.UpdatedResponse and nil error while calling AcceptInvitation. nil responses are not supported"))
		return
	}
...
func (s *invitationServiceServer) serveAcceptInvitationProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "AcceptInvitation")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *invitationServiceServer) serveRejectInvitation(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *invitationServiceServer) serveRejectInvitationJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RejectInvitation")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.InvitationService.RejectInvitation(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *cm.UpdatedResponse and nil error while calling RejectInvitation. nil responses are not supported"))
		return
	}
...
func (s *invitationServiceServer) serveRejectInvitationProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RejectInvitation")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *invitationServiceServer) serveGetInvitationByToken(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveGetInvitationByTokenJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveGetInvitationByTokenProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *invitationServiceServer) serveGetInvitationByTokenJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetInvitationByToken")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(GetInvitationByTokenRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, malformedRequestError("the json request could not be decoded"))
		return
	...
	// Call service method
	var respContent *Invitation
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.InvitationService.GetInvitationByToken(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Invitation and nil error while calling GetInvitationByToken. nil responses are not supported"))
		return
	}
...
func (s *invitationServiceServer) serveGetInvitationByTokenProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetInvitationByToken")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *invitationServiceServer) serveGetInvitations(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveGetInvitationsJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveGetInvitationsProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *invitationServiceServer) serveGetInvitationsJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetInvitations")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(GetInvitationsRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, malformedRequestError("the json request could not be decoded"))
		return
	...
	// Call service method
	var respContent *InvitationsResponse
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.InvitationService.GetInvitations(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *InvitationsResponse and nil error while calling GetInvitations. nil responses are not supported"))
		return
	}
...
func (s *invitationServiceServer) serveGetInvitationsProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetInvitations")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *invitationServiceServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 7
}

func (s *invitationServiceServer) ProtocGenTwirpVersion() string {
	return "v5.8.0"
}
