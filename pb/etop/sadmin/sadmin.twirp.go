...
func (c *miscServiceProtobufClient) VersionInfo(ctx context.Context, in *cm.Empty) (*cm.VersionInfoResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "sadmin")
...
func (c *userServiceProtobufClient) CreateUser(ctx context.Context, in *SAdminCreateUserRequest) (*etop.RegisterResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "sadmin")
	ctx = ctxsetters.WithServiceName(ctx, "User")
	ctx = ctxsetters.WithMethodName(ctx, "CreateUser")
	out := new(etop.RegisterResponse)
	err := doProtobufRequest(ctx, c.client, c.urls[0], in, out)
	if err != nil {
		return nil, err
	}
...
func (c *userServiceProtobufClient) ResetPassword(ctx context.Context, in *SAdminResetPasswordRequest) (*cm.Empty, error) {
	ctx = ctxsetters.WithPackageName(ctx, "sadmin")
	ctx = ctxsetters.WithServiceName(ctx, "User")
...
func (c *userServiceProtobufClient) LoginAsAccount(ctx context.Context, in *LoginAsAccountRequest) (*etop.LoginResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "sadmin")
	ctx = ctxsetters.WithServiceName(ctx, "User")
	ctx = ctxsetters.WithMethodName(ctx, "LoginAsAccount")
...
func (c *userServiceJSONClient) CreateUser(ctx context.Context, in *SAdminCreateUserRequest) (*etop.RegisterResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "sadmin")
	ctx = ctxsetters.WithServiceName(ctx, "User")
	ctx = ctxsetters.WithMethodName(ctx, "CreateUser")
	out := new(etop.RegisterResponse)
...
func (c *userServiceJSONClient) ResetPassword(ctx context.Context, in *SAdminResetPasswordRequest) (*cm.Empty, error) {
	ctx = ctxsetters.WithPackageName(ctx, "sadmin")
	ctx = ctxsetters.WithServiceName(ctx, "User")
	ctx = ctxsetters.WithMethodName(ctx, "ResetPassword")
	out := new(cm.Empty)
...
func (c *userServiceJSONClient) LoginAsAccount(ctx context.Context, in *LoginAsAccountRequest) (*etop.LoginResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "sadmin")
	ctx = ctxsetters.WithServiceName(ctx, "User")
	ctx = ctxsetters.WithMethodName(ctx, "LoginAsAccount")
	out := new(etop.LoginResponse)
...
func (s *userServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "/api/sadmin.User/LoginAsAccount":
		s.serveLoginAsAccount(ctx, resp, req)
		return
	default:
		msg := fmt.Sprintf("no handler for path %q", req.URL.Path)
		err = badRouteError(msg, req.Method, req.URL.Path)
...
func (s *userServiceServer) serveCreateUserJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	reqContent := new(SAdminCreateUserRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, wrapInternal(err, "failed to parse request json"))
		return
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *etop.RegisterResponse and nil error while calling CreateUser. nil responses are not supported"))
		return
	}
...
func (s *userServiceServer) serveResetPasswordJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	reqContent := new(SAdminResetPasswordRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, wrapInternal(err, "failed to parse request json"))
		return
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *cm.Empty and nil error while calling ResetPassword. nil responses are not supported"))
		return
	}
...
func (s *userServiceServer) serveLoginAsAccount(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveLoginAsAccountJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveLoginAsAccountProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *userServiceServer) serveLoginAsAccountJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "LoginAsAccount")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.UserService.LoginAsAccount(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *etop.LoginResponse and nil error while calling LoginAsAccount. nil responses are not supported"))
		return
	}
...
func (s *userServiceServer) serveLoginAsAccountProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "LoginAsAccount")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
