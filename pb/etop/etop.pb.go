...
type Supplier struct {
	...
	Status               status3.Status   `protobuf:"varint,3,opt,name=status,enum=status3.Status" json:"status"`
	IsTest               bool             `protobuf:"varint,4,opt,name=is_test,json=isTest" json:"is_test"`
	CompanyInfo          *CompanyInfo     `protobuf:"bytes,5,opt,name=company_info,json=companyInfo" json:"company_info,omitempty"`
	WarehouseAddress     *Address         `protobuf:"bytes,6,opt,name=warehouse_address,json=warehouseAddress" json:"warehouse_address,omitempty"`
	BankAccount          *BankAccount     `protobuf:"bytes,7,opt,name=bank_account,json=bankAccount" json:"bank_account,omitempty"`
	ContactPersons       []*ContactPerson `protobuf:"bytes,8,rep,name=contact_persons,json=contactPersons" json:"contact_persons,omitempty"`
	ShipFromAddressId    int64            `protobuf:"varint,9,opt,name=ship_from_address_id,json=shipFromAddressId" json:"ship_from_address_id"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *Supplier) GetIsTest() bool {
	if m != nil {
		return m.IsTest
	}
	return false
...
func (m *Supplier) GetCompanyInfo() *CompanyInfo {
	if m != nil {
		return m.CompanyInfo
	}
	return nil
...
func (m *Supplier) GetWarehouseAddress() *Address {
	if m != nil {
...
func (m *Supplier) GetBankAccount() *BankAccount {
	if m != nil {
		return m.BankAccount
	}
	return nil
...
func (m *Supplier) GetContactPersons() []*ContactPerson {
	if m != nil {
		return m.ContactPersons
	}
	return nil
...
func (m *Supplier) GetShipFromAddressId() int64 {
	if m != nil {
		return m.ShipFromAddressId
	}
	return 0
...
type SuppliersResponse struct {
	...
	Suppliers            []*Supplier      `protobuf:"bytes,2,rep,name=suppliers" json:"suppliers,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
type LoginResponse struct {
	...
	Supplier *Supplier     `protobuf:"bytes,6,opt,name=supplier" json:"supplier,omitempty"`
	// @required
...
func (m *LoginResponse) GetSupplier() *Supplier {
	if m != nil {
		return m.Supplier
	}
	return nil
...
func (m *AccessTokenResponse) GetSupplier() *Supplier {
	if m != nil {
		return m.Supplier
	}
	return nil
...
func (m *Credit) GetSupplierId() int64 {
	if m != nil {
		return m.SupplierId
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*Supplier)(nil), "etop.Supplier")
	proto.RegisterType((*SuppliersResponse)(nil), "etop.SuppliersResponse")
