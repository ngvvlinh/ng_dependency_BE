...
type AccountService interface {
	...
	UpdateExternalAccountAhamoveVerificationImages(context.Context, *UpdateXAccountAhamoveVerificationImagesRequest) (*cm.UpdatedResponse, error)
}
...
func (c *accountServiceProtobufClient) UpdateExternalAccountAhamoveVerificationImages(ctx context.Context, in *UpdateXAccountAhamoveVerificationImagesRequest) (*cm.UpdatedResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "shop")
	ctx = ctxsetters.WithServiceName(ctx, "Account")
...
func (c *accountServiceJSONClient) UpdateExternalAccountAhamoveVerificationImages(ctx context.Context, in *UpdateXAccountAhamoveVerificationImagesRequest) (*cm.UpdatedResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "shop")
	ctx = ctxsetters.WithServiceName(ctx, "Account")
	ctx = ctxsetters.WithMethodName(ctx, "UpdateExternalAccountAhamoveVerificationImages")
	out := new(cm.UpdatedResponse)
...
func (s *accountServiceServer) serveUpdateExternalAccountAhamoveVerificationImagesJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	reqContent := new(UpdateXAccountAhamoveVerificationImagesRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, wrapInternal(err, "failed to parse request json"))
		return
