...
func NewAccountServiceProtobufClient(addr string, client HTTPClient) AccountService {
	...
	urls := [4]string{
		...
		prefix + "UpdateAffiliateBankAccount",
...
func (c *accountServiceProtobufClient) RegisterAffiliate(ctx context.Context, in *RegisterAffiliateRequest) (*etop.Affiliate, error) {
	ctx = ctxsetters.WithPackageName(ctx, "affiliate")
	ctx = ctxsetters.WithServiceName(ctx, "Account")
	ctx = ctxsetters.WithMethodName(ctx, "RegisterAffiliate")
	out := new(etop.Affiliate)
	err := doProtobufRequest(ctx, c.client, c.urls[0], in, out)
	if err != nil {
		return nil, err
	}
...
func (c *accountServiceProtobufClient) UpdateAffiliate(ctx context.Context, in *UpdateAffiliateRequest) (*etop.Affiliate, error) {
	ctx = ctxsetters.WithPackageName(ctx, "affiliate")
	ctx = ctxsetters.WithServiceName(ctx, "Account")
...
func (c *accountServiceProtobufClient) UpdateAffiliateBankAccount(ctx context.Context, in *UpdateAffiliateBankAccountRequest) (*etop.Affiliate, error) {
	ctx = ctxsetters.WithPackageName(ctx, "affiliate")
	ctx = ctxsetters.WithServiceName(ctx, "Account")
	ctx = ctxsetters.WithMethodName(ctx, "UpdateAffiliateBankAccount")
	out := new(etop.Affiliate)
...
func (c *accountServiceJSONClient) RegisterAffiliate(ctx context.Context, in *RegisterAffiliateRequest) (*etop.Affiliate, error) {
	ctx = ctxsetters.WithPackageName(ctx, "affiliate")
	ctx = ctxsetters.WithServiceName(ctx, "Account")
	ctx = ctxsetters.WithMethodName(ctx, "RegisterAffiliate")
	out := new(etop.Affiliate)
...
func (c *accountServiceJSONClient) UpdateAffiliate(ctx context.Context, in *UpdateAffiliateRequest) (*etop.Affiliate, error) {
	ctx = ctxsetters.WithPackageName(ctx, "affiliate")
	ctx = ctxsetters.WithServiceName(ctx, "Account")
	ctx = ctxsetters.WithMethodName(ctx, "UpdateAffiliate")
	out := new(etop.Affiliate)
...
func (c *accountServiceJSONClient) UpdateAffiliateBankAccount(ctx context.Context, in *UpdateAffiliateBankAccountRequest) (*etop.Affiliate, error) {
	ctx = ctxsetters.WithPackageName(ctx, "affiliate")
	ctx = ctxsetters.WithServiceName(ctx, "Account")
	ctx = ctxsetters.WithMethodName(ctx, "UpdateAffiliateBankAccount")
	out := new(etop.Affiliate)
...
func (s *accountServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "/api/affiliate.Account/UpdateAffiliateBankAccount":
		s.serveUpdateAffiliateBankAccount(ctx, resp, req)
		return
...
func (s *accountServiceServer) serveRegisterAffiliateJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	// Call service method
	var respContent *etop.Affiliate
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *etop.Affiliate and nil error while calling RegisterAffiliate. nil responses are not supported"))
		return
	}
...
func (s *accountServiceServer) serveUpdateAffiliateJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *etop.Affiliate and nil error while calling UpdateAffiliate. nil responses are not supported"))
		return
	}
...
func (s *accountServiceServer) serveUpdateAffiliateBankAccount(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveUpdateAffiliateBankAccountJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveUpdateAffiliateBankAccountProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *accountServiceServer) serveUpdateAffiliateBankAccountJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "UpdateAffiliateBankAccount")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(UpdateAffiliateBankAccountRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, malformedRequestError("the json request could not be decoded"))
		return
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.AccountService.UpdateAffiliateBankAccount(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *etop.Affiliate and nil error while calling UpdateAffiliateBankAccount. nil responses are not supported"))
		return
	}
...
func (s *accountServiceServer) serveUpdateAffiliateBankAccountProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "UpdateAffiliateBankAccount")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
