...
type GetProductPromotionRequest struct {
	ProductId            int64    `protobuf:"varint,1,opt,name=product_id,json=productId" json:"product_id"`
	ReferralCode         *int64   `protobuf:"varint,2,opt,name=referral_code,json=referralCode" json:"referral_code,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetProductPromotionRequest) GetReferralCode() int64 {
