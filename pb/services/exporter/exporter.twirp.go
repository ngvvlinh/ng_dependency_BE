...
func (c *miscServiceProtobufClient) VersionInfo(ctx context.Context, in *cm.Empty) (*cm.VersionInfoResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "exporter")
...
const MiscServicePathPrefix = "/api/exporter.Misc/"
...
func (s *miscServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/api/exporter.Misc/VersionInfo":
