...
var ACL = map[string]*permission.PermissionDecl{
	...
	"crmservice.Vtiger/CreateOrUpdateContact":             {Type: Public},
	"crmservice.Vtiger/GetTickets":                        {Type: Shop},
	"crmservice.Vtiger/CreateTicket":                      {Type: Shop},
	"crmservice.Vtiger/UpdateTicket":                      {Type: Shop},
	"crmservice.Vtiger/GetCategories":                     {Type: Shop},
	"crmservice.Vtiger/GetStatus":                         {Type: EtopAdmin},
	"crmservice.Vtiger/CreateOrUpdateLead":                {Type: Public},
	"crmservice.Vtiger/CountTicketByStatus":               {Type: EtopAdmin},
	"crmservice.Vtiger/GetTicketStatusCount":              {Type: EtopAdmin},
	"crmservice.Vht/GetCallHistories":                     {Type: EtopAdmin},
