...
var _acl = map[string]*permission.Decl{
	...
	"etop.User/GetAuthCodeURL":           {Type: Public},
	"etop.User/VerifyTokenUsingCode":     {Type: Public},
	...
	"ext/shop.Etelecom/ListCallLogs":     {Type: Shop, Auth: APIKey},

	"ext/shop.Contact/ListContacts":  {Type: Shop, Auth: APIKey},
	"ext/shop.Contact/CreateContact": {Type: Shop, Auth: APIKey},
	...
	"admin.Connection/UpdateConnectDirectShipmentShopSetting": {Type: EtopAdmin, Actions: actions(AdminConnectDirectShipmentUpdate)},
