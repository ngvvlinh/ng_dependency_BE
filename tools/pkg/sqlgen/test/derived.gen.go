...
func (m *UserUnion) __sqlSelect(w SQLWriter) {
	...
	core.WriteCols(w, string(__sqlUserUnion_As), (*User)(nil).SQLListCols())
	w.WriteByte(',')
	core.WriteCols(w, string(__sqlUserUnion_JoinAs[0]), (*UserInfo)(nil).SQLListCols())
}
...
func (m *UserUnion) __sqlJoin(w SQLWriter, types []sq.JOIN_TYPE) {
	...
	w.WriteName((*UserInfo)(nil).SQLTableName())
	w.WriteRawString(" AS ")
...
func (m *UserUnionMore) __sqlSelect(w SQLWriter) {
	w.WriteRawString("SELECT ")
	core.WriteCols(w, string(__sqlUserUnionMore_As), (*User)(nil).SQLListCols())
	w.WriteByte(',')
	core.WriteCols(w, string(__sqlUserUnionMore_JoinAs[0]), (*UserInfo)(nil).SQLListCols())
	w.WriteByte(',')
	core.WriteCols(w, string(__sqlUserUnionMore_JoinAs[1]), (*UserSubset)(nil).SQLListCols())
}
...
func (m *UserUnionMore) __sqlJoin(w SQLWriter, types []sq.JOIN_TYPE) {
	...
	w.WriteRawString(" JOIN ")
	w.WriteName((*UserSubset)(nil).SQLTableName())
	w.WriteRawString(" AS ")
