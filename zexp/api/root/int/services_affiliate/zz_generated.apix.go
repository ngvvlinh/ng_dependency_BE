...
const AffiliateServicePathPrefix = "/api/etop_affiliate.Affiliate/"
...
func (s *AffiliateServiceServer) parseRoute(path string) (reqMsg proto.Message, _ httprpc.ExecFunc, _ error) {
	switch path {
	case "/api/etop_affiliate.Affiliate/AffiliateGetProducts":
		...
		return msg, fn, nil
	case "/api/etop_affiliate.Affiliate/CreateOrUpdateAffiliateCommissionSetting":
...
const ShopServicePathPrefix = "/api/etop_affiliatetop.Shop/"
...
const TradingServicePathPrefix = "/api/etop_affiliatetop.Trading/"
...
func (s *TradingServiceServer) parseRoute(path string) (reqMsg proto.Message, _ httprpc.ExecFunc, _ error) {
	switch path {
	case "/api/etop_affiliatetop.Trading/CreateOrUpdateTradingCommissionSetting":
		...
		return msg, fn, nil
	case "/api/etop_affiliatetop.Trading/CreateTradingProductPromotion":
		msg := new(affiliate.CreateOrUpdateProductPromotionRequest)
		fn := func(ctx context.Context) (proto.Message, error) {
			return s.TradingAPI.CreateTradingProductPromotion(ctx, msg)
		}
		return msg, fn, nil
	case "/api/etop_affiliatetop.Trading/GetTradingProductPromotionByProductIDs":
		...
		return msg, fn, nil
	case "/api/etop_affiliatetop.Trading/GetTradingProductPromotions":
		msg := new(common.CommonListRequest)
		fn := func(ctx context.Context) (proto.Message, error) {
			return s.TradingAPI.GetTradingProductPromotions(ctx, msg)
		}
		return msg, fn, nil
	case "/api/etop_affiliatetop.Trading/TradingGetProducts":
		msg := new(common.CommonListRequest)
		fn := func(ctx context.Context) (proto.Message, error) {
			return s.TradingAPI.TradingGetProducts(ctx, msg)
		}
		return msg, fn, nil
	case "/api/etop_affiliatetop.Trading/UpdateTradingProductPromotion":
		msg := new(affiliate.CreateOrUpdateProductPromotionRequest)
		fn := func(ctx context.Context) (proto.Message, error) {
...
const UserServicePathPrefix = "/api/etop_affiliatetop.User/"
...
func (s *UserServiceServer) parseRoute(path string) (reqMsg proto.Message, _ httprpc.ExecFunc, _ error) {
	switch path {
	case "/api/etop_affiliatetop.User/UpdateReferral":
