...
func (m *ShopLedger) Migration(db *cmsql.Database) {
	...
	mModelColumnNameAndType := map[string]migration.ColumnDef{
		...
		"type": {
			...
			ColumnDBType:     "enum",
			ColumnTag:        "enum(shop_ledger_type)",
