...
func (m *Fulfillment) Migration(db *cmsql.Database) {
	...
	mModelColumnNameAndType := map[string]migration.ColumnDef{
		...
		"lines": {
			ColumnName:       "lines",
			ColumnType:       "[]*ordermodel.OrderLine",
			ColumnDBType:     "[]*struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
...
func (m *FulfillmentHistory) SQLScan(opts core.Opts, row *sql.Row) error {
	...
	res := make(FulfillmentHistory, 99)
	res["id"] = data[0]
	res["order_id"] = data[1]
	res["shop_id"] = data[2]
	...
	res["lines"] = data[32]
	res["address_from"] = data[33]
	res["address_to"] = data[34]
	res["address_return"] = data[35]
	res["address_to_province_code"] = data[36]
	res["address_to_district_code"] = data[37]
	res["address_to_ward_code"] = data[38]
	res["created_at"] = data[39]
	res["updated_at"] = data[40]
	res["closed_at"] = data[41]
	res["expected_delivery_at"] = data[42]
	res["expected_pick_at"] = data[43]
	res["cod_etop_transfered_at"] = data[44]
	res["shipping_fee_shop_transfered_at"] = data[45]
	res["shipping_cancelled_at"] = data[46]
	res["shipping_delivered_at"] = data[47]
	res["shipping_returned_at"] = data[48]
	res["shipping_created_at"] = data[49]
	res["shipping_picking_at"] = data[50]
	res["shipping_holding_at"] = data[51]
	res["shipping_delivering_at"] = data[52]
	res["shipping_returning_at"] = data[53]
	res["money_transaction_id"] = data[54]
	res["money_transaction_shipping_external_id"] = data[55]
	res["cancel_reason"] = data[56]
	res["shipping_provider"] = data[57]
	res["provider_service_id"] = data[58]
	res["shipping_code"] = data[59]
	res["shipping_note"] = data[60]
	res["try_on"] = data[61]
	res["include_insurance"] = data[62]
	res["connection_id"] = data[63]
	res["connection_method"] = data[64]
	res["shipping_service_name"] = data[65]
	res["external_shipping_name"] = data[66]
	res["external_shipping_id"] = data[67]
	res["external_shipping_code"] = data[68]
	res["external_shipping_created_at"] = data[69]
	res["external_shipping_updated_at"] = data[70]
	res["external_shipping_cancelled_at"] = data[71]
	res["external_shipping_delivered_at"] = data[72]
	res["external_shipping_returned_at"] = data[73]
	res["external_shipping_closed_at"] = data[74]
	res["external_shipping_state"] = data[75]
	res["external_shipping_state_code"] = data[76]
	res["external_shipping_status"] = data[77]
	res["external_shipping_note"] = data[78]
	res["external_shipping_sub_state"] = data[79]
	res["external_shipping_data"] = data[80]
	res["shipping_state"] = data[81]
	res["shipping_status"] = data[82]
	res["etop_payment_status"] = data[83]
	res["status"] = data[84]
	res["sync_status"] = data[85]
	res["sync_states"] = data[86]
	res["last_sync_at"] = data[87]
	res["external_shipping_logs"] = data[88]
	res["admin_note"] = data[89]
	res["is_partial_delivery"] = data[90]
	res["created_by"] = data[91]
	res["gross_weight"] = data[92]
	res["chargeable_weight"] = data[93]
	res["length"] = data[94]
	res["width"] = data[95]
	res["height"] = data[96]
	res["delivery_route"] = data[97]
	res["rid"] = data[98]
	*m = res
	return nil
}
...
func (ms *FulfillmentHistories) SQLScan(opts core.Opts, rows *sql.Rows) error {
	...
	for rows.Next() {
		...
		m["lines"] = data[32]
		m["address_from"] = data[33]
		m["address_to"] = data[34]
		m["address_return"] = data[35]
		m["address_to_province_code"] = data[36]
		m["address_to_district_code"] = data[37]
		m["address_to_ward_code"] = data[38]
		m["created_at"] = data[39]
		m["updated_at"] = data[40]
		m["closed_at"] = data[41]
		m["expected_delivery_at"] = data[42]
		m["expected_pick_at"] = data[43]
		m["cod_etop_transfered_at"] = data[44]
		m["shipping_fee_shop_transfered_at"] = data[45]
		m["shipping_cancelled_at"] = data[46]
		m["shipping_delivered_at"] = data[47]
		m["shipping_returned_at"] = data[48]
		m["shipping_created_at"] = data[49]
		m["shipping_picking_at"] = data[50]
		m["shipping_holding_at"] = data[51]
		m["shipping_delivering_at"] = data[52]
		m["shipping_returning_at"] = data[53]
		m["money_transaction_id"] = data[54]
		m["money_transaction_shipping_external_id"] = data[55]
		m["cancel_reason"] = data[56]
		m["shipping_provider"] = data[57]
		m["provider_service_id"] = data[58]
		m["shipping_code"] = data[59]
		m["shipping_note"] = data[60]
		m["try_on"] = data[61]
		m["include_insurance"] = data[62]
		m["connection_id"] = data[63]
		m["connection_method"] = data[64]
		m["shipping_service_name"] = data[65]
		m["external_shipping_name"] = data[66]
		m["external_shipping_id"] = data[67]
		m["external_shipping_code"] = data[68]
		m["external_shipping_created_at"] = data[69]
		m["external_shipping_updated_at"] = data[70]
		m["external_shipping_cancelled_at"] = data[71]
		m["external_shipping_delivered_at"] = data[72]
		m["external_shipping_returned_at"] = data[73]
		m["external_shipping_closed_at"] = data[74]
		m["external_shipping_state"] = data[75]
		m["external_shipping_state_code"] = data[76]
		m["external_shipping_status"] = data[77]
		m["external_shipping_note"] = data[78]
		m["external_shipping_sub_state"] = data[79]
		m["external_shipping_data"] = data[80]
		m["shipping_state"] = data[81]
		m["shipping_status"] = data[82]
		m["etop_payment_status"] = data[83]
		m["status"] = data[84]
		m["sync_status"] = data[85]
		m["sync_states"] = data[86]
		m["last_sync_at"] = data[87]
		m["external_shipping_logs"] = data[88]
		m["admin_note"] = data[89]
		m["is_partial_delivery"] = data[90]
		m["created_by"] = data[91]
		m["gross_weight"] = data[92]
		m["chargeable_weight"] = data[93]
		m["length"] = data[94]
		m["width"] = data[95]
		m["height"] = data[96]
		m["delivery_route"] = data[97]
		m["rid"] = data[98]
		res = append(res, m)
	}
	if err := rows.Err(); err != nil {
