...
import (
	...
	"o.o/backend/zexp/sample/calc3/model"
	"o.o/capi/dot"
)
...
func (s *EquationStore) UpdateEquation(eq *api.Equation) (int, error) {
	...
	eqDB = convert.Convert_api_Equation_calc3model_Equation(eq, eqDB)
...
func (s *EquationStore) ListEquation() (*api.Equations, error) {
	...
	eqs = convert.Convert_calc3model_Equations_api_Equations(eqDBs)
	res := &api.Equations{
		Equations: eqs,
	}
	return res, nil
