...
VALUES (100085369475949390, 'eTelecom', 1, now(), now(), 'crm/_/builtin/portsip', 'telecom', 'builtin', 'portsip', 'LN20');
...
VALUES (100085369475949390, 'default_token', 0, true, now(), now(), '{"username": "", "password": "", "tenant_host": "", "tenant_token": "", "tenant_domain": ""}', now(), now());
