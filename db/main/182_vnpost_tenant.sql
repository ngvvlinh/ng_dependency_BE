INSERT INTO "public"."connection" ("id", "name", "status", "partner_id", "created_at", "updated_at", "deleted_at", "driver_config", "driver", "connection_type", "connection_subtype", "connection_method", "connection_provider", "etop_affiliate_account", "code") VALUES ('1000632092361806111', 'Etelecom', '1', NULL, NOW(), NOW(), NULL, NULL, 'crm/_/direct/vht', 'telecom', NULL, 'direct', 'vht', NULL, 'F57J');
