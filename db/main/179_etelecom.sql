...
INSERT INTO shop_connection(connection_id, token, status, is_global, created_at, updated_at, telecom_data, token_expires_at)
VALUES (100085369475949390, 'default_token', 1, true, now(), now(), '{"username": "", "password": "", "tenant_host": "", "tenant_token": ""}', now());
