...
type ResetStateRequest struct {
	WebhookId            dot.ID   `protobuf:"varint,1,opt,name=webhook_id,json=webhookId" json:"webhook_id"`
...
func (m *ResetStateRequest) GetWebhookId() dot.ID {
	if m != nil {
		return m.WebhookId
	}
	return 0
...
func (m *ResetStateRequest) GetAccountId() dot.ID {
	if m != nil {
		return m.AccountId
	}
	return 0
...
var fileDescriptor_cb80502182612866 = []byte{
	...
	0x22, 0x26, 0x64, 0x45, 0x50, 0x71, 0xcf, 0x14, 0xa7, 0xc0, 0x13, 0x0f, 0xe5, 0x18, 0x2f, 0x3c,
	...
	0x0f, 0x1e, 0xc9, 0x31, 0x4c, 0x78, 0x2c, 0xc7, 0x30, 0xe3, 0xb1, 0x1c, 0x43, 0x94, 0x7c, 0x6a,
	0x49, 0x7e, 0x81, 0x5e, 0x59, 0x9e, 0x7e, 0x62, 0x41, 0xa6, 0x7e, 0x41, 0x92, 0x3e, 0xba, 0x9f,
	0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x2e, 0x59, 0x07, 0xc6, 0x06, 0x01, 0x00, 0x00,
}
