...
type SpreadsheetData struct {
	Columns              []string `protobuf:"bytes,1,rep,name=columns" json:"columns"`
	RawColumns           []string `protobuf:"bytes,2,rep,name=raw_columns,json=rawColumns" json:"raw_columns"`
	Rows                 []*Row   `protobuf:"bytes,3,rep,name=rows" json:"rows"`
...
type Row struct {
	Cell                 []string `protobuf:"bytes,1,rep,name=cell" json:"cell"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_1bd31ad9e73e401e = []byte{
	...
	0x07, 0x6a, 0x09, 0x98, 0xed, 0x14, 0x7c, 0xe2, 0xa1, 0x1c, 0xe3, 0x85, 0x87, 0x72, 0x0c, 0x0f,
	...
	0x86, 0x09, 0x8f, 0xe5, 0x18, 0x66, 0x3c, 0x96, 0x63, 0x88, 0x52, 0x4c, 0x2d, 0xc9, 0x2f, 0xd0,
	0x2b, 0xcb, 0xd3, 0x4f, 0x2c, 0xc8, 0xd4, 0x2f, 0x48, 0xd2, 0xc7, 0x0c, 0x18, 0x40, 0x00, 0x00,
	0x00, 0xff, 0xff, 0x77, 0x84, 0x79, 0x15, 0x2d, 0x01, 0x00, 0x00,
}
