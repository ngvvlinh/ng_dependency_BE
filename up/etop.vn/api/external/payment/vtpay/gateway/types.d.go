...
func (h AggregateHandler) HandleGetResult(ctx context.Context, msg *GetResultCommand) error {
	result, err := h.inner.GetResult(msg.GetArgs(ctx))
	msg.Result = result
	return err
}

func (h AggregateHandler) HandleValidateTransaction(ctx context.Context, msg *ValidateTransactionCommand) error {
	result, err := h.inner.ValidateTransaction(msg.GetArgs(ctx))
	msg.Result = result
	return err
}
