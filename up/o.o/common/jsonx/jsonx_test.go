...
func testValidate(t *testing.T) {
	t.Run("no tag (error)", func(t *testing.T) {
		...
		require.EqualError(t, err, "field String of type o.o/common/jsonx.Invalid must have json tag")
	})
	t.Run("no tag with time (error)", func(t *testing.T) {
		reset()
		_, _, err := validate(InvalidTime{}, withRoute)
		require.EqualError(t, err, "field Time of type o.o/common/jsonx.InvalidTime must have json tag")
	})
	...
	t.Run("revalidate struct with invalid interface (error)", func(t *testing.T) {
		...
		require.EqualError(t, err, "field Interface of type o.o/common/jsonx.C: field String of type o.o/common/jsonx.Invalid must have json tag")
	})
	...
	t.Run("revalidate indirect struct with invalid interface (error)", func(t *testing.T) {
		...
		t.Run("map", func(t *testing.T) {
			...
			require.EqualError(t, err, "field MapC of type o.o/common/jsonx.D: field Interface of type o.o/common/jsonx.C: field String of type o.o/common/jsonx.Invalid must have json tag")
		})
		t.Run("slice", func(t *testing.T) {
			value := &E{
				SliceC: []*C{
			...
			_, _, err := validate(value, withRoute)
			require.EqualError(t, err, "field SliceC of type o.o/common/jsonx.E: field Interface of type o.o/common/jsonx.C: field String of type o.o/common/jsonx.Invalid must have json tag")
		})
	})
}
...
func TestMarshal(t *testing.T) {
	...
	t.Run("invalid (error)", func(t *testing.T) {
		...
		require.Equal(t, errs[0].Message, "field Interface of type o.o/common/jsonx.C: field String of type o.o/common/jsonx.Invalid must have json tag")
	})
}
