...
const AccountUserServicePathPrefix = "/admin.AccountUser/"

const Path_AccountUser_GetAccountUsers = "/admin.AccountUser/GetAccountUsers"
...
func (s *AccountUserServiceServer) parseRoute(path string, hooks httprpc.Hooks, info *httprpc.HookInfo) (reqMsg capi.Message, _ httprpc.ExecFunc, _ error) {
	switch path {
	case "/admin.AccountUser/GetAccountUsers":
...
func (s *ConnectionServiceServer) parseRoute(path string, hooks httprpc.Hooks, info *httprpc.HookInfo) (reqMsg capi.Message, _ httprpc.ExecFunc, _ error) {
	...
	case "/admin.Connection/GetConnections":
		...
		return msg, fn, nil
	case "/admin.Connection/UpdateConnectDirectShipmentShopSetting":
		msg := &inttypes.UpdateDirectShipmentSettingRequest{}
		fn := func(ctx context.Context) (newCtx context.Context, resp capi.Message, err error) {
			inner := s.builder()
			info.Request, info.Inner = msg, inner
			newCtx, err = hooks.RequestRouted(ctx, *info)
			...
			resp, err = inner.UpdateConnectDirectShipmentShopSetting(newCtx, msg)
			return
		}
		return msg, fn, nil
...
const TransactionServicePathPrefix = "/admin.Transaction/"

const Path_Transaction_GetTransactions = "/admin.Transaction/GetTransactions"
...
func (s *TransactionServiceServer) parseRoute(path string, hooks httprpc.Hooks, info *httprpc.HookInfo) (reqMsg capi.Message, _ httprpc.ExecFunc, _ error) {
	switch path {
	case "/admin.Transaction/GetTransactions":
		msg := &inttypes.GetAdminTransactionsRequest{}
		fn := func(ctx context.Context) (newCtx context.Context, resp capi.Message, err error) {
			inner := s.builder()
			info.Request, info.Inner = msg, inner
			newCtx, err = hooks.RequestRouted(ctx, *info)
