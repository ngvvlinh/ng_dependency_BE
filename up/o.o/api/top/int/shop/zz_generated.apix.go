...
func NewServer(builder interface{}, hooks ...httprpc.HooksBuilder) (httprpc.Server, bool) {
	...
	case func() SettingService:
		return NewSettingServiceServer(builder, hooks...), true
	...
	case func() TransactionService:
		return NewTransactionServiceServer(builder, hooks...), true
...
type SettingServiceServer struct {
	hooks   httprpc.HooksBuilder
	builder func() SettingService
}

func NewSettingServiceServer(builder func() SettingService, hooks ...httprpc.HooksBuilder) httprpc.Server {
...
func (s *SettingServiceServer) PathPrefix() string {
	return SettingServicePathPrefix
}

func (s *SettingServiceServer) WithHooks(hooks httprpc.HooksBuilder) httprpc.Server {
	result := *s
	result.hooks = httprpc.ChainHooks(s.hooks, hooks)
	return &result
}
...
func (s *SettingServiceServer) parseRoute(path string, hooks httprpc.Hooks, info *httprpc.HookInfo) (reqMsg capi.Message, _ httprpc.ExecFunc, _ error) {
	switch path {
	case "/shop.Setting/GetSetting":
		msg := &common.Empty{}
		fn := func(ctx context.Context) (newCtx context.Context, resp capi.Message, err error) {
			inner := s.builder()
			info.Request, info.Inner = msg, inner
		...
		return msg, fn, nil
	case "/shop.Setting/UpdateSetting":
		msg := &UpdateSettingRequest{}
		fn := func(ctx context.Context) (newCtx context.Context, resp capi.Message, err error) {
			inner := s.builder()
			info.Request, info.Inner = msg, inner
			newCtx, err = hooks.RequestRouted(ctx, *info)
			...
			resp, err = inner.UpdateSetting(newCtx, msg)
			return
		}
		return msg, fn, nil
	default:
...
type TransactionServiceServer struct {
	hooks   httprpc.HooksBuilder
	builder func() TransactionService
}

func NewTransactionServiceServer(builder func() TransactionService, hooks ...httprpc.HooksBuilder) httprpc.Server {
...
const TransactionServicePathPrefix = "/shop.Transaction/"

const Path_Transaction_GetTransaction = "/shop.Transaction/GetTransaction"
const Path_Transaction_GetTransactions = "/shop.Transaction/GetTransactions"

func (s *TransactionServiceServer) PathPrefix() string {
	return TransactionServicePathPrefix
}

func (s *TransactionServiceServer) WithHooks(hooks httprpc.HooksBuilder) httprpc.Server {
	result := *s
	result.hooks = httprpc.ChainHooks(s.hooks, hooks)
	return &result
}
...
func (s *TransactionServiceServer) parseRoute(path string, hooks httprpc.Hooks, info *httprpc.HookInfo) (reqMsg capi.Message, _ httprpc.ExecFunc, _ error) {
	...
	case "/shop.Transaction/GetTransaction":
		...
		fn := func(ctx context.Context) (newCtx context.Context, resp capi.Message, err error) {
			...
			resp, err = inner.GetTransaction(newCtx, msg)
			return
		}
		return msg, fn, nil
