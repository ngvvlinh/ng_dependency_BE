...
func NewEcomServiceServer(builder func() EcomService, hooks ...*httprpc.Hooks) httprpc.Server {
...
func (s *EcomServiceServer) parseRoute(path string) (reqMsg capi.Message, _ httprpc.ExecFunc, _ error) {
	switch path {
