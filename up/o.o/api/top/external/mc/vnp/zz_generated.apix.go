...
const WebhookServicePathPrefix = "/vnposts/webhook/"

const Path_Webhook_CreateWebhook = "/vnposts/webhook/createwebhook"
const Path_Webhook_DeleteWebhook = "/vnposts/webhook/deletewebhook"
const Path_Webhook_GetChanges = "/vnposts/webhook/GetChanges"
const Path_Webhook_GetWebhooks = "/vnposts/webhook/getwebhooks"
...
func (s *WebhookServiceServer) parseRoute(path string, hooks httprpc.Hooks, info *httprpc.HookInfo) (reqMsg capi.Message, _ httprpc.ExecFunc, _ error) {
	switch path {
	case "/vnposts/webhook/createwebhook":
		...
		return msg, fn, nil
	case "/vnposts/webhook/deletewebhook":
		...
		return msg, fn, nil
	case "/vnposts/webhook/GetChanges":
		msg := &common.Empty{}
		fn := func(ctx context.Context) (newCtx context.Context, resp capi.Message, err error) {
			inner := s.builder()
			info.Request, info.Inner = msg, inner
		...
		return msg, fn, nil
	case "/vnposts/webhook/getwebhooks":
		msg := &common.Empty{}
		fn := func(ctx context.Context) (newCtx context.Context, resp capi.Message, err error) {
			inner := s.builder()
			info.Request, info.Inner = msg, inner
