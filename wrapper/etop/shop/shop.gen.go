...
import (
	...
	shopz "etop.vn/backend/zexp/api/root/int/shop"
	l "etop.vn/common/l"
)
...
func NewShopServer(mux Muxer, hooks *twirp.ServerHooks) {
	...
	mux.Handle(shopz.BrandServicePathPrefix, shopz.NewBrandServiceServer(BrandService{}))
	mux.Handle(shopz.InventoryServicePathPrefix, shopz.NewInventoryServiceServer(InventoryService{}))
	mux.Handle(shopz.AccountServicePathPrefix, shopz.NewAccountServiceServer(AccountService{}))
	mux.Handle(shopz.ExternalAccountServicePathPrefix, shopz.NewExternalAccountServiceServer(ExternalAccountService{}))
	mux.Handle(shopz.CollectionServicePathPrefix, shopz.NewCollectionServiceServer(CollectionService{}))
	mux.Handle(shopz.CustomerServicePathPrefix, shopz.NewCustomerServiceServer(CustomerService{}))
	mux.Handle(shopz.CustomerGroupServicePathPrefix, shopz.NewCustomerGroupServiceServer(CustomerGroupService{}))
	mux.Handle(shopz.ProductServicePathPrefix, shopz.NewProductServiceServer(ProductService{}))
	mux.Handle(shopz.CategoryServicePathPrefix, shopz.NewCategoryServiceServer(CategoryService{}))
	mux.Handle(shopz.ProductSourceServicePathPrefix, shopz.NewProductSourceServiceServer(ProductSourceService{}))
	mux.Handle(shopz.OrderServicePathPrefix, shopz.NewOrderServiceServer(OrderService{}))
	mux.Handle(shopz.FulfillmentServicePathPrefix, shopz.NewFulfillmentServiceServer(FulfillmentService{}))
	mux.Handle(shopz.ShipnowServicePathPrefix, shopz.NewShipnowServiceServer(ShipnowService{}))
	mux.Handle(shopz.HistoryServicePathPrefix, shopz.NewHistoryServiceServer(HistoryService{}))
	mux.Handle(shopz.MoneyTransactionServicePathPrefix, shopz.NewMoneyTransactionServiceServer(MoneyTransactionService{}))
	mux.Handle(shopz.SummaryServicePathPrefix, shopz.NewSummaryServiceServer(SummaryService{}))
	mux.Handle(shopz.ExportServicePathPrefix, shopz.NewExportServiceServer(ExportService{}))
	mux.Handle(shopz.NotificationServicePathPrefix, shopz.NewNotificationServiceServer(NotificationService{}))
	mux.Handle(shopz.AuthorizeServicePathPrefix, shopz.NewAuthorizeServiceServer(AuthorizeService{}))
	mux.Handle(shopz.TradingServicePathPrefix, shopz.NewTradingServiceServer(TradingService{}))
	mux.Handle(shopz.PaymentServicePathPrefix, shopz.NewPaymentServiceServer(PaymentService{}))
	mux.Handle(shopz.ReceiptServicePathPrefix, shopz.NewReceiptServiceServer(ReceiptService{}))
	mux.Handle(shopz.SupplierServicePathPrefix, shopz.NewSupplierServiceServer(SupplierService{}))
	mux.Handle(shopz.CarrierServicePathPrefix, shopz.NewCarrierServiceServer(CarrierService{}))
	mux.Handle(shopz.LedgerServicePathPrefix, shopz.NewLedgerServiceServer(LedgerService{}))
}
