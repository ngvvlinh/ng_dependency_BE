...
func ConnectAdminService(addr string, client *http.Client) error {
	...
	bus.AddHandler("client", func(ctx context.Context, q *CreateCategoryEndpoint) error { panic("Unexpected") })
	bus.AddHandler("client", func(ctx context.Context, q *GetCategoriesEndpoint) error { panic("Unexpected") })
	bus.AddHandler("client", func(ctx context.Context, q *RemoveProductsCategoryEndpoint) error { panic("Unexpected") })
	bus.AddHandler("client", func(ctx context.Context, q *UpdateProductsCategoryEndpoint) error { panic("Unexpected") })
	...
	bus.AddHandler("client", func(ctx context.Context, q *UpdateProductsStatusEndpoint) error { panic("Unexpected") })
...
func (c *AdminClient) CreateCategory(ctx context.Context, in *admin.CreateCategoryRequest) (*etop.Category, error) {
	resp, err := c._CategoryService.CreateCategory(ctx, in)
...
func (c *AdminClient) GetCategories(ctx context.Context, in *cm.Empty) (*etop.CategoriesResponse, error) {
...
func (c *AdminClient) RemoveProductsCategory(ctx context.Context, in *cm.IDsRequest) (*cm.UpdatedResponse, error) {
	resp, err := c._CategoryService.RemoveProductsCategory(ctx, in)
...
func (c *AdminClient) UpdateProductsCategory(ctx context.Context, in *admin.UpdateProductsCategoryRequest) (*cm.UpdatedResponse, error) {
	resp, err := c._CategoryService.UpdateProductsCategory(ctx, in)
...
func (c *AdminClient) GetProduct(ctx context.Context, in *cm.IDRequest) (*admin.ProductWithSupplier, error) {
...
func (c *AdminClient) GetVariant(ctx context.Context, in *cm.IDRequest) (*admin.VariantWithSupplier, error) {
...
func (c *AdminClient) UpdateProductsStatus(ctx context.Context, in *admin.UpdateProductsStatusRequest) (*cm.UpdatedResponse, error) {
	resp, err := c._ProductService.UpdateProductsStatus(ctx, in)
...
func NewAdminServer(mux Muxer, hooks *twirp.ServerHooks) {
	...
	bus.Expect(&RemoveProductsCategoryEndpoint{})
	bus.Expect(&UpdateProductsCategoryEndpoint{})
...
type CreateCategoryEndpoint struct {
	*admin.CreateCategoryRequest
	Result  *etop.Category
	Context AdminClaim
}

func (s CategoryService) CreateCategory(ctx context.Context, req *admin.CreateCategoryRequest) (resp *etop.Category, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Category/CreateCategory"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s CategoryService) GetCategories(ctx context.Context, req *cm.Empty) (resp *etop.CategoriesResponse, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Category/GetCategories"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
type RemoveProductsCategoryEndpoint struct {
	*cm.IDsRequest
	Result  *cm.UpdatedResponse
	Context AdminClaim
}

func (s CategoryService) RemoveProductsCategory(ctx context.Context, req *cm.IDsRequest) (resp *cm.UpdatedResponse, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Category/RemoveProductsCategory"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
	...
	session = sessionQuery.Result
	query := &RemoveProductsCategoryEndpoint{IDsRequest: req}
	query.Context.Claim = session.Claim
	query.Context.IsEtopAdmin = session.IsEtopAdmin
	query.Context.IsOwner = session.IsOwner
	query.Context.Roles = session.Roles
...
type UpdateProductsCategoryEndpoint struct {
	*admin.UpdateProductsCategoryRequest
	Result  *cm.UpdatedResponse
	Context AdminClaim
}

func (s CategoryService) UpdateProductsCategory(ctx context.Context, req *admin.UpdateProductsCategoryRequest) (resp *cm.UpdatedResponse, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Category/UpdateProductsCategory"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
	...
	session = sessionQuery.Result
	query := &UpdateProductsCategoryEndpoint{UpdateProductsCategoryRequest: req}
	query.Context.Claim = session.Claim
	query.Context.IsEtopAdmin = session.IsEtopAdmin
	query.Context.IsOwner = session.IsOwner
	query.Context.Roles = session.Roles
...
type GetProductEndpoint struct {
	*cm.IDRequest
	Result  *admin.ProductWithSupplier
	Context AdminClaim
}

func (s ProductService) GetProduct(ctx context.Context, req *cm.IDRequest) (resp *admin.ProductWithSupplier, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Product/GetProduct"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s ProductService) GetProducts(ctx context.Context, req *admin.GetProductsRequest) (resp *admin.ProductsResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Product/GetProducts"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
	...
	session = sessionQuery.Result
	query := &GetProductsEndpoint{GetProductsRequest: req}
	query.Context.Claim = session.Claim
	query.Context.IsEtopAdmin = session.IsEtopAdmin
	query.Context.IsOwner = session.IsOwner
	query.Context.Roles = session.Roles
...
func (s ProductService) GetProductsByIDs(ctx context.Context, req *cm.IDsRequest) (resp *admin.ProductsResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Product/GetProductsByIDs"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
type GetVariantEndpoint struct {
	*cm.IDRequest
	Result  *admin.VariantWithSupplier
	Context AdminClaim
}

func (s ProductService) GetVariant(ctx context.Context, req *cm.IDRequest) (resp *admin.VariantWithSupplier, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Product/GetVariant"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s ProductService) GetVariants(ctx context.Context, req *admin.GetVariantsRequest) (resp *admin.VariantsResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Product/GetVariants"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s ProductService) GetVariantsByIDs(ctx context.Context, req *cm.IDsRequest) (resp *admin.VariantsResponse, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Product/GetVariantsByIDs"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s ProductService) UpdateProduct(ctx context.Context, req *admin.UpdateProductRequest) (resp *admin.Product, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Product/UpdateProduct"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s ProductService) UpdateProductImages(ctx context.Context, req *shop.UpdateVariantImagesRequest) (resp *admin.Product, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Product/UpdateProductImages"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
type UpdateProductsStatusEndpoint struct {
	*admin.UpdateProductsStatusRequest
	Result  *cm.UpdatedResponse
	Context AdminClaim
}

func (s ProductService) UpdateProductsStatus(ctx context.Context, req *admin.UpdateProductsStatusRequest) (resp *cm.UpdatedResponse, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Product/UpdateProductsStatus"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
	...
	session = sessionQuery.Result
	query := &UpdateProductsStatusEndpoint{UpdateProductsStatusRequest: req}
	query.Context.Claim = session.Claim
	query.Context.IsEtopAdmin = session.IsEtopAdmin
	query.Context.IsOwner = session.IsOwner
	query.Context.Roles = session.Roles
...
func (s ProductService) UpdateVariant(ctx context.Context, req *admin.UpdateVariantRequest) (resp *admin.Variant, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Product/UpdateVariant"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
func (s ProductService) UpdateVariantImages(ctx context.Context, req *shop.UpdateVariantImagesRequest) (resp *admin.Variant, err error) {
	...
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Product/UpdateVariantImages"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
...
type UpdateVariantsStatusEndpoint struct {
	*admin.UpdateVariantsStatusRequest
	Result  *cm.UpdatedResponse
	Context AdminClaim
}

func (s ProductService) UpdateVariantsStatus(ctx context.Context, req *admin.UpdateVariantsStatusRequest) (resp *cm.UpdatedResponse, err error) {
	t0 := time.Now()
	var session *middleware.Session
	var errs []*cm.Error
	const rpcName = "admin.Product/UpdateVariantsStatus"
	defer func() {
		recovered := recover()
		err = cmWrapper.RecoverAndLog(ctx, rpcName, session, req, resp, recovered, err, errs, t0)
	}()
