...
func (m *EtopAcount) Migration(db *cmsql.Database) {
	var mDBColumnNameAndType map[string]string
	if val, err := migration.GetColumnNamesAndTypes(db, "etop_acount"); err != nil {
		db.RecordError(err)
		return
	} else {
	...
	if err := migration.Compare(db, "etop_acount", mModelColumnNameAndType, mDBColumnNameAndType); err != nil {
		db.RecordError(err)
	}
}
...
func (m *VtigerContact) Migration(db *cmsql.Database) {
	var mDBColumnNameAndType map[string]string
	if val, err := migration.GetColumnNamesAndTypes(db, "vtiger_contact"); err != nil {
		db.RecordError(err)
		return
	} else {
		mDBColumnNameAndType = val
	...
	mModelColumnNameAndType := map[string]migration.ColumnDef{
		...
		"used_shipping_provider": {
			ColumnName:       "used_shipping_provider",
			ColumnType:       "string",
			ColumnDBType:     "string",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
	...
	if err := migration.Compare(db, "vtiger_contact", mModelColumnNameAndType, mDBColumnNameAndType); err != nil {
		db.RecordError(err)
	}
}
...
func (m *VtigerContact) SQLArgs(opts core.Opts, create bool) []interface{} {
	...
	return []interface{}{
		...
		core.Time(m.VtigerCreatedAt),
		core.Time(m.VtigerUpdatedAt),
	}
}
...
func (m *VtigerContact) SQLUpdate(w SQLWriter) error {
	...
	if m.EtopUserID != 0 {
		flag = true
		w.WriteName("etop_user_id")
		w.WriteByte('=')
		w.WriteMarker()
		w.WriteByte(',')
		w.WriteArg(m.EtopUserID)
	}
	...
	if !m.VtigerCreatedAt.IsZero() {
		flag = true
		w.WriteName("vtiger_created_at")
		w.WriteByte('=')
		w.WriteMarker()
		w.WriteByte(',')
		w.WriteArg(m.VtigerCreatedAt)
	}
	if !m.VtigerUpdatedAt.IsZero() {
		flag = true
		w.WriteName("vtiger_updated_at")
		w.WriteByte('=')
		w.WriteMarker()
		w.WriteByte(',')
		w.WriteArg(m.VtigerUpdatedAt)
	}
	if !flag {
		return core.ErrNoColumn
	}
...
func (m VtigerContactHistory) EtopUserID() core.Interface  { return core.Interface{m["etop_user_id"]} }
...
func (m VtigerContactHistory) VtigerCreatedAt() core.Interface {
	return core.Interface{m["vtiger_created_at"]}
}
func (m VtigerContactHistory) VtigerUpdatedAt() core.Interface {
	return core.Interface{m["vtiger_updated_at"]}
}
...
func (m *VtigerContactHistory) SQLScan(opts core.Opts, row *sql.Row) error {
	...
	res := make(VtigerContactHistory, 26)
	res["id"] = data[0]
	...
	res["vtiger_created_at"] = data[24]
	res["vtiger_updated_at"] = data[25]
	*m = res
	return nil
}
...
func (ms *VtigerContactHistories) SQLScan(opts core.Opts, rows *sql.Rows) error {
	...
	for rows.Next() {
		...
		m["vtiger_created_at"] = data[24]
		m["vtiger_updated_at"] = data[25]
		res = append(res, m)
	}
	if err := rows.Err(); err != nil {
		return err
