...
func (m *MoneyTransactionShipping) Migration(db *cmsql.Database) {
	var mDBColumnNameAndType map[string]string
	if val, err := migration.GetColumnNamesAndTypes(db, "money_transaction_shipping"); err != nil {
		db.RecordError(err)
		return
	} else {
	...
	mModelColumnNameAndType := map[string]migration.ColumnDef{
		...
		"money_transaction_shipping_etop_id": {
			ColumnName:       "money_transaction_shipping_etop_id",
			ColumnType:       "dot.ID",
			ColumnDBType:     "int64",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
...
func (m *MoneyTransactionShippingEtop) Migration(db *cmsql.Database) {
	var mDBColumnNameAndType map[string]string
	if val, err := migration.GetColumnNamesAndTypes(db, "money_transaction_shipping_etop"); err != nil {
		db.RecordError(err)
		return
	} else {
		mDBColumnNameAndType = val
	...
	mModelColumnNameAndType := map[string]migration.ColumnDef{
		...
		"total_money_transaction": {
			ColumnName:       "total_money_transaction",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
...
func (m *MoneyTransactionShippingExternal) Migration(db *cmsql.Database) {
	var mDBColumnNameAndType map[string]string
	if val, err := migration.GetColumnNamesAndTypes(db, "money_transaction_shipping_external"); err != nil {
		db.RecordError(err)
		return
	} else {
		mDBColumnNameAndType = val
...
func (m *MoneyTransactionShippingExternalLine) Migration(db *cmsql.Database) {
	var mDBColumnNameAndType map[string]string
	if val, err := migration.GetColumnNamesAndTypes(db, "money_transaction_shipping_external_line"); err != nil {
		db.RecordError(err)
		return
	} else {
		mDBColumnNameAndType = val
	...
	mModelColumnNameAndType := map[string]migration.ColumnDef{
		...
		"external_closed_at": {
			ColumnName:       "external_closed_at",
			ColumnType:       "time.Time",
			ColumnDBType:     "struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"etop_fulfillment_id_raw": {
			ColumnName:       "etop_fulfillment_id_raw",
			ColumnType:       "string",
			ColumnDBType:     "string",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"etop_fulfillment_id": {
			ColumnName:       "etop_fulfillment_id",
			ColumnType:       "dot.ID",
			ColumnDBType:     "int64",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"import_error": {
			ColumnName:       "import_error",
			ColumnType:       "*etopmodel.Error",
			ColumnDBType:     "*struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"external_total_shipping_fee": {
			ColumnName:       "external_total_shipping_fee",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
	...
	if err := migration.Compare(db, "money_transaction_shipping_external_line", mModelColumnNameAndType, mDBColumnNameAndType); err != nil {
		db.RecordError(err)
	}
}
...
func (m *MoneyTransactionShippingExternalLineExtended) SQLSelect(w SQLWriter) error {
	...
	w.WriteByte(' ')
	(*MoneyTransactionShippingExternalLineExtended)(nil).__sqlJoin(w)
	return nil
}
...
func (m *MoneyTransactionShippingExternalLineExtended) SQLJoin(w SQLWriter) error {
	m.__sqlJoin(w)
	return nil
}

func (m *MoneyTransactionShippingExternalLineExtendeds) SQLJoin(w SQLWriter) error {
	return (*MoneyTransactionShippingExternalLineExtended)(nil).SQLJoin(w)
}

func (m *MoneyTransactionShippingExternalLineExtended) __sqlSelect(w SQLWriter) {
	w.WriteRawString("SELECT ")
	core.WriteCols(w, "m", (*MoneyTransactionShippingExternalLine)(nil).SQLListCols())
	w.WriteByte(',')
...
func (m *MoneyTransactionShippingExternalLineExtended) __sqlJoin(w SQLWriter) {
	...
	w.WriteQueryString(" f.id = m.etop_fulfillment_id")
	w.WriteRawString(" LEFT JOIN ")
...
func (m *MoneyTransactionShippingFtShop) SQLSelect(w SQLWriter) error {
	...
	w.WriteByte(' ')
	(*MoneyTransactionShippingFtShop)(nil).__sqlJoin(w)
	return nil
}
...
func (m *MoneyTransactionShippingFtShop) SQLJoin(w SQLWriter) error {
	m.__sqlJoin(w)
	return nil
}

func (m *MoneyTransactionShippingFtShops) SQLJoin(w SQLWriter) error {
	return (*MoneyTransactionShippingFtShop)(nil).SQLJoin(w)
}

func (m *MoneyTransactionShippingFtShop) __sqlSelect(w SQLWriter) {
	w.WriteRawString("SELECT ")
	core.WriteCols(w, "m", (*MoneyTransactionShipping)(nil).SQLListCols())
	w.WriteByte(',')
	core.WriteCols(w, "s", (*identitymodel.Shop)(nil).SQLListCols())
}

func (m *MoneyTransactionShippingFtShop) __sqlJoin(w SQLWriter) {
	w.WriteRawString("FROM ")
	w.WriteName("money_transaction_shipping")
	w.WriteRawString(" AS ")
	w.WriteName("m")
	...
	w.WriteName((*identitymodel.Shop)(nil).SQLTableName())
	w.WriteRawString(" AS s ON")
	w.WriteQueryString(" s.id = m.shop_id")
}
