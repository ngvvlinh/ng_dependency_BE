...
// Type ShopStocktake represents table shop_stocktake
func sqlgenStocktake(_ *ShopStocktake) bool { return true }

type ShopStocktakes []*ShopStocktake

const __sqlShopStocktake_Table = "shop_stocktake"
const __sqlShopStocktake_ListCols = "\"id\",\"shop_id\",\"total_quantity\",\"created_by\",\"updated_by\",\"code\",\"code_norm\",\"status\",\"created_at\",\"updated_at\",\"confirmed_at\",\"cancelled_at\",\"lines\",\"note\""
...
func (m *ShopStocktakeHistory) SQLScan(opts core.Opts, row *sql.Row) error {
	...
	res := make(ShopStocktakeHistory, 14)
	res["id"] = data[0]
	res["shop_id"] = data[1]
