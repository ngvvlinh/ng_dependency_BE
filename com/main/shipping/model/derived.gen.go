...
func (m *FulfillmentHistory) SQLScan(opts core.Opts, row *sql.Row) error {
	data := make([]interface{}, 103)
	args := make([]interface{}, 103)
	for i := 0; i < 103; i++ {
		args[i] = &data[i]
	}
	...
	res := make(FulfillmentHistory, 103)
	res["id"] = data[0]
	res["order_id"] = data[1]
	res["shop_id"] = data[2]
