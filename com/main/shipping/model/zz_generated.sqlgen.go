...
func (m *FulfillmentHistory) SQLScan(opts core.Opts, row *sql.Row) error {
	data := make([]interface{}, 114)
	args := make([]interface{}, 114)
	for i := 0; i < 114; i++ {
		args[i] = &data[i]
	}
	...
	res := make(FulfillmentHistory, 114)
	res["id"] = data[0]
	res["order_id"] = data[1]
	res["shop_id"] = data[2]
