...
func (m *FulfillmentHistory) SQLScan(opts core.Opts, row *sql.Row) error {
	data := make([]interface{}, 109)
	args := make([]interface{}, 109)
	for i := 0; i < 109; i++ {
		args[i] = &data[i]
	}
	...
	res := make(FulfillmentHistory, 109)
	res["id"] = data[0]
	res["order_id"] = data[1]
	res["shop_id"] = data[2]
