...
func (m FulfillmentHistory) ShipmentPriceListID() core.Interface {
...
func (m *FulfillmentHistory) SQLScan(opts core.Opts, row *sql.Row) error {
	...
	res["coupon"] = data[105]
	res["shipment_price_list_id"] = data[106]
	res["rid"] = data[107]
	*m = res
	return nil
}
...
func (ms *FulfillmentHistories) SQLScan(opts core.Opts, rows *sql.Rows) error {
	...
	for rows.Next() {
		...
		m["coupon"] = data[105]
		m["shipment_price_list_id"] = data[106]
		m["rid"] = data[107]
		res = append(res, m)
	}
	if err := rows.Err(); err != nil {
