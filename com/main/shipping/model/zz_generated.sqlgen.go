...
func (m *Fulfillment) Migration(db *cmsql.Database) {
	var mDBColumnNameAndType map[string]string
	if val, err := migration.GetColumnNamesAndTypes(db, "fulfillment"); err != nil {
		db.RecordError(err)
		return
	} else {
	...
	mModelColumnNameAndType := map[string]migration.ColumnDef{
		...
		"original_cod_amount": {
			ColumnName:       "original_cod_amount",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"actual_compensation_amount": {
			ColumnName:       "actual_compensation_amount",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"shipping_fee_customer": {
			ColumnName:       "shipping_fee_customer",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"shipping_fee_shop_lines": {
			ColumnName:       "shipping_fee_shop_lines",
		...
		"external_shipping_fee": {
			ColumnName:       "external_shipping_fee",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"provider_shipping_fee_lines": {
			ColumnName:       "provider_shipping_fee_lines",
			ColumnType:       "[]*sharemodel.ShippingFeeLine",
			ColumnDBType:     "[]*struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"etop_fee_adjustment": {
			ColumnName:       "etop_fee_adjustment",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"shipping_fee_return": {
			ColumnName:       "shipping_fee_return",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"shipping_fee_insurance": {
			ColumnName:       "shipping_fee_insurance",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"shipping_fee_adjustment": {
			ColumnName:       "shipping_fee_adjustment",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"shipping_fee_cods": {
			ColumnName:       "shipping_fee_cods",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"shipping_fee_info_change": {
			ColumnName:       "shipping_fee_info_change",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"etop_adjusted_shipping_fee_main": {
			ColumnName:       "etop_adjusted_shipping_fee_main",
			ColumnType:       "int",
			ColumnDBType:     "int",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"lines": {
			ColumnName:       "lines",
			ColumnType:       "[]*orderingmodel.OrderLine",
			ColumnDBType:     "[]*struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"type_from": {
			ColumnName:       "type_from",
			ColumnType:       "etopmodel.FulfillmentEndpoint",
			ColumnDBType:     "string",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		...
		"address_from": {
			...
			ColumnType:       "*addressmodel.Address",
			ColumnDBType:     "*struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		...
		"address_to_ward_code": {
			ColumnName:       "address_to_ward_code",
			ColumnType:       "string",
			ColumnDBType:     "string",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"expected_delivery_at": {
			ColumnName:       "expected_delivery_at",
			ColumnType:       "time.Time",
			ColumnDBType:     "struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"shipping_fee_shop_transfered_at": {
			ColumnName:       "shipping_fee_shop_transfered_at",
			ColumnType:       "time.Time",
			ColumnDBType:     "struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"shipping_returned_at": {
			ColumnName:       "shipping_returned_at",
			ColumnType:       "time.Time",
			ColumnDBType:     "struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"shipping_holding_at": {
			ColumnName:       "shipping_holding_at",
			ColumnType:       "time.Time",
			ColumnDBType:     "struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"shipping_returning_at": {
			ColumnName:       "shipping_returning_at",
			ColumnType:       "time.Time",
			ColumnDBType:     "struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"money_transaction_id": {
			ColumnName:       "money_transaction_id",
			ColumnType:       "dot.ID",
			ColumnDBType:     "int64",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"money_transaction_shipping_external_id": {
			ColumnName:       "money_transaction_shipping_external_id",
			ColumnType:       "dot.ID",
			ColumnDBType:     "int64",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"shipping_provider": {
			...
			ColumnDBType:     "enum",
			ColumnTag:        "",
			ColumnEnumValues: []string{"unknown", "all", "manual", "ghn", "ghtk", "vtpost", "etop", "partner", "ninjavan", "dhl", "ntx"},
		},
		"provider_service_id": {
		...
		"shipping_payment_type": {
			ColumnName:       "shipping_payment_type",
		...
		"external_shipping_name": {
			ColumnName:       "external_shipping_name",
			ColumnType:       "string",
			ColumnDBType:     "string",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"external_shipping_id": {
			ColumnName:       "external_shipping_id",
			ColumnType:       "string",
			ColumnDBType:     "string",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"external_shipping_code": {
			ColumnName:       "external_shipping_code",
			ColumnType:       "string",
			ColumnDBType:     "string",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"external_shipping_created_at": {
			ColumnName:       "external_shipping_created_at",
			ColumnType:       "time.Time",
			ColumnDBType:     "struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"external_shipping_updated_at": {
			ColumnName:       "external_shipping_updated_at",
			ColumnType:       "time.Time",
			ColumnDBType:     "struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"external_shipping_cancelled_at": {
			ColumnName:       "external_shipping_cancelled_at",
			ColumnType:       "time.Time",
			ColumnDBType:     "struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"external_shipping_delivered_at": {
			ColumnName:       "external_shipping_delivered_at",
			ColumnType:       "time.Time",
			ColumnDBType:     "struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"external_shipping_returned_at": {
			ColumnName:       "external_shipping_returned_at",
			ColumnType:       "time.Time",
			ColumnDBType:     "struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"external_shipping_closed_at": {
			ColumnName:       "external_shipping_closed_at",
			ColumnType:       "time.Time",
			ColumnDBType:     "struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"external_shipping_state": {
			ColumnName:       "external_shipping_state",
			ColumnType:       "string",
			ColumnDBType:     "string",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"external_shipping_state_code": {
			ColumnName:       "external_shipping_state_code",
			ColumnType:       "string",
			ColumnDBType:     "string",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"external_shipping_status": {
			ColumnName:       "external_shipping_status",
		...
		"external_shipping_data": {
			ColumnName:       "external_shipping_data",
		...
		"shipping_state": {
			...
			ColumnType:       "shipping.State",
			ColumnDBType:     "enum",
			ColumnTag:        "",
			ColumnEnumValues: []string{"unknown", "default", "created", "confirmed", "processing", "picking", "holding", "returning", "returned", "delivering", "delivered", "cancelled", "undeliverable"},
		},
		"shipping_status": {
		...
		"external_shipping_logs": {
			...
			ColumnType:       "[]*ExternalShippingLog",
			ColumnDBType:     "[]*struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		...
		"is_partial_delivery": {
			ColumnName:       "is_partial_delivery",
			ColumnType:       "bool",
			ColumnDBType:     "bool",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"external_affiliate_id": {
			ColumnName:       "external_affiliate_id",
			ColumnType:       "string",
			ColumnDBType:     "string",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		...
		"shipment_price_info": {
			ColumnName:       "shipment_price_info",
			ColumnType:       "*sharemodel.ShipmentPriceInfo",
			ColumnDBType:     "*struct",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
		},
		"lines_content": {
			ColumnName:       "lines_content",
			ColumnType:       "string",
			ColumnDBType:     "string",
			ColumnTag:        "",
			ColumnEnumValues: []string{},
	...
	if err := migration.Compare(db, "fulfillment", mModelColumnNameAndType, mDBColumnNameAndType); err != nil {
		db.RecordError(err)
	}
}
...
func (m *Fulfillment) SQLArgs(opts core.Opts, create bool) []interface{} {
	...
	return []interface{}{
		...
		core.JSON{m.ShipmentPriceInfo},
		core.String(m.LinesContent),
		core.String(m.EdCode),
		m.ShippingSubstate,
		core.String(m.ExternalSortCode),
		m.Rid,
	}
}
...
func (m *Fulfillment) SQLUpdate(w SQLWriter) error {
	...
	if m.ShippingPaymentType != 0 {
		flag = true
		w.WriteName("shipping_payment_type")
		w.WriteByte('=')
		w.WriteMarker()
		w.WriteByte(',')
		w.WriteArg(m.ShippingPaymentType)
	}
	if m.ConnectionID != 0 {
		flag = true
	...
	if m.ShipmentPriceInfo != nil {
		flag = true
		w.WriteName("shipment_price_info")
		w.WriteByte('=')
		w.WriteMarker()
		w.WriteByte(',')
		w.WriteArg(core.JSON{m.ShipmentPriceInfo})
	}
	if m.LinesContent != "" {
		flag = true
		w.WriteName("lines_content")
		w.WriteByte('=')
		w.WriteMarker()
		w.WriteByte(',')
		w.WriteArg(m.LinesContent)
	}
	if m.EdCode != "" {
		flag = true
		w.WriteName("ed_code")
	...
	if m.ShippingSubstate.Valid {
		...
		w.WriteMarker()
		w.WriteByte(',')
		w.WriteArg(m.ShippingSubstate)
	}
	if m.ExternalSortCode != "" {
		flag = true
		w.WriteName("external_sort_code")
		w.WriteByte('=')
		w.WriteMarker()
		w.WriteByte(',')
		w.WriteArg(m.ExternalSortCode)
	}
	if m.Rid != 0 {
		flag = true
		w.WriteName("rid")
...
func (m FulfillmentHistory) UpdatedBy() core.Interface { return core.Interface{m["updated_by"]} }
...
func (m FulfillmentHistory) AddressToPhone() core.Interface {
	return core.Interface{m["address_to_phone"]}
}
func (m FulfillmentHistory) AddressToFullNameNorm() core.Interface {
...
func (m FulfillmentHistory) ShippingPaymentType() core.Interface {
	return core.Interface{m["shipping_payment_type"]}
}
...
func (m FulfillmentHistory) ShipmentPriceInfo() core.Interface {
	return core.Interface{m["shipment_price_info"]}
}
func (m FulfillmentHistory) LinesContent() core.Interface { return core.Interface{m["lines_content"]} }
func (m FulfillmentHistory) EdCode() core.Interface       { return core.Interface{m["ed_code"]} }
func (m FulfillmentHistory) ShippingSubstate() core.Interface {
	return core.Interface{m["shipping_substate"]}
}
func (m FulfillmentHistory) ExternalSortCode() core.Interface {
	return core.Interface{m["external_sort_code"]}
}
...
func (m *FulfillmentHistory) SQLScan(opts core.Opts, row *sql.Row) error {
	data := make([]interface{}, 115)
	args := make([]interface{}, 115)
	for i := 0; i < 115; i++ {
		args[i] = &data[i]
	}
	...
	res := make(FulfillmentHistory, 115)
	res["id"] = data[0]
	res["order_id"] = data[1]
	res["shop_id"] = data[2]
	...
	res["updated_by"] = data[29]
	res["etop_adjusted_shipping_fee_main"] = data[30]
	res["etop_price_rule"] = data[31]
	res["variant_ids"] = data[32]
	res["lines"] = data[33]
	res["type_from"] = data[34]
	res["type_to"] = data[35]
	res["address_from"] = data[36]
	res["address_to"] = data[37]
	res["address_return"] = data[38]
	res["address_to_province_code"] = data[39]
	res["address_to_district_code"] = data[40]
	res["address_to_ward_code"] = data[41]
	res["address_to_phone"] = data[42]
	res["address_to_full_name_norm"] = data[43]
	res["created_at"] = data[44]
	res["updated_at"] = data[45]
	res["closed_at"] = data[46]
	res["expected_delivery_at"] = data[47]
	res["expected_pick_at"] = data[48]
	res["cod_etop_transfered_at"] = data[49]
	res["shipping_fee_shop_transfered_at"] = data[50]
	res["shipping_cancelled_at"] = data[51]
	res["shipping_delivered_at"] = data[52]
	res["shipping_returned_at"] = data[53]
	res["shipping_created_at"] = data[54]
	res["shipping_picking_at"] = data[55]
	res["shipping_holding_at"] = data[56]
	res["shipping_delivering_at"] = data[57]
	res["shipping_returning_at"] = data[58]
	res["money_transaction_id"] = data[59]
	res["money_transaction_shipping_external_id"] = data[60]
	res["cancel_reason"] = data[61]
	res["shipping_provider"] = data[62]
	res["provider_service_id"] = data[63]
	res["shipping_code"] = data[64]
	res["shipping_note"] = data[65]
	res["try_on"] = data[66]
	res["include_insurance"] = data[67]
	res["insurance_value"] = data[68]
	res["shipping_type"] = data[69]
	res["shipping_payment_type"] = data[70]
	res["connection_id"] = data[71]
	res["connection_method"] = data[72]
	res["shop_carrier_id"] = data[73]
	res["shipping_service_name"] = data[74]
	res["external_shipping_name"] = data[75]
	res["external_shipping_id"] = data[76]
	res["external_shipping_code"] = data[77]
	res["external_shipping_created_at"] = data[78]
	res["external_shipping_updated_at"] = data[79]
	res["external_shipping_cancelled_at"] = data[80]
	res["external_shipping_delivered_at"] = data[81]
	res["external_shipping_returned_at"] = data[82]
	res["external_shipping_closed_at"] = data[83]
	res["external_shipping_state"] = data[84]
	res["external_shipping_state_code"] = data[85]
	res["external_shipping_status"] = data[86]
	res["external_shipping_note"] = data[87]
	res["external_shipping_sub_state"] = data[88]
	res["external_shipping_data"] = data[89]
	res["shipping_state"] = data[90]
	res["shipping_status"] = data[91]
	res["etop_payment_status"] = data[92]
	res["status"] = data[93]
	res["sync_status"] = data[94]
	res["sync_states"] = data[95]
	res["last_sync_at"] = data[96]
	res["external_shipping_logs"] = data[97]
	res["admin_note"] = data[98]
	res["is_partial_delivery"] = data[99]
	res["created_by"] = data[100]
	res["gross_weight"] = data[101]
	res["chargeable_weight"] = data[102]
	res["length"] = data[103]
	res["width"] = data[104]
	res["height"] = data[105]
	res["delivery_route"] = data[106]
	res["external_affiliate_id"] = data[107]
	res["coupon"] = data[108]
	res["shipment_price_info"] = data[109]
	res["lines_content"] = data[110]
	res["ed_code"] = data[111]
	res["shipping_substate"] = data[112]
	res["external_sort_code"] = data[113]
	res["rid"] = data[114]
	*m = res
	return nil
}
...
func (ms *FulfillmentHistories) SQLScan(opts core.Opts, rows *sql.Rows) error {
	...
	for rows.Next() {
		...
		m["updated_by"] = data[29]
		m["etop_adjusted_shipping_fee_main"] = data[30]
		m["etop_price_rule"] = data[31]
		m["variant_ids"] = data[32]
		m["lines"] = data[33]
		m["type_from"] = data[34]
		m["type_to"] = data[35]
		m["address_from"] = data[36]
		m["address_to"] = data[37]
		m["address_return"] = data[38]
		m["address_to_province_code"] = data[39]
		m["address_to_district_code"] = data[40]
		m["address_to_ward_code"] = data[41]
		m["address_to_phone"] = data[42]
		m["address_to_full_name_norm"] = data[43]
		m["created_at"] = data[44]
		m["updated_at"] = data[45]
		m["closed_at"] = data[46]
		m["expected_delivery_at"] = data[47]
		m["expected_pick_at"] = data[48]
		m["cod_etop_transfered_at"] = data[49]
		m["shipping_fee_shop_transfered_at"] = data[50]
		m["shipping_cancelled_at"] = data[51]
		m["shipping_delivered_at"] = data[52]
		m["shipping_returned_at"] = data[53]
		m["shipping_created_at"] = data[54]
		m["shipping_picking_at"] = data[55]
		m["shipping_holding_at"] = data[56]
		m["shipping_delivering_at"] = data[57]
		m["shipping_returning_at"] = data[58]
		m["money_transaction_id"] = data[59]
		m["money_transaction_shipping_external_id"] = data[60]
		m["cancel_reason"] = data[61]
		m["shipping_provider"] = data[62]
		m["provider_service_id"] = data[63]
		m["shipping_code"] = data[64]
		m["shipping_note"] = data[65]
		m["try_on"] = data[66]
		m["include_insurance"] = data[67]
		m["insurance_value"] = data[68]
		m["shipping_type"] = data[69]
		m["shipping_payment_type"] = data[70]
		m["connection_id"] = data[71]
		m["connection_method"] = data[72]
		m["shop_carrier_id"] = data[73]
		m["shipping_service_name"] = data[74]
		m["external_shipping_name"] = data[75]
		m["external_shipping_id"] = data[76]
		m["external_shipping_code"] = data[77]
		m["external_shipping_created_at"] = data[78]
		m["external_shipping_updated_at"] = data[79]
		m["external_shipping_cancelled_at"] = data[80]
		m["external_shipping_delivered_at"] = data[81]
		m["external_shipping_returned_at"] = data[82]
		m["external_shipping_closed_at"] = data[83]
		m["external_shipping_state"] = data[84]
		m["external_shipping_state_code"] = data[85]
		m["external_shipping_status"] = data[86]
		m["external_shipping_note"] = data[87]
		m["external_shipping_sub_state"] = data[88]
		m["external_shipping_data"] = data[89]
		m["shipping_state"] = data[90]
		m["shipping_status"] = data[91]
		m["etop_payment_status"] = data[92]
		m["status"] = data[93]
		m["sync_status"] = data[94]
		m["sync_states"] = data[95]
		m["last_sync_at"] = data[96]
		m["external_shipping_logs"] = data[97]
		m["admin_note"] = data[98]
		m["is_partial_delivery"] = data[99]
		m["created_by"] = data[100]
		m["gross_weight"] = data[101]
		m["chargeable_weight"] = data[102]
		m["length"] = data[103]
		m["width"] = data[104]
		m["height"] = data[105]
		m["delivery_route"] = data[106]
		m["external_affiliate_id"] = data[107]
		m["coupon"] = data[108]
		m["shipment_price_info"] = data[109]
		m["lines_content"] = data[110]
		m["ed_code"] = data[111]
		m["shipping_substate"] = data[112]
		m["external_sort_code"] = data[113]
		m["rid"] = data[114]
		res = append(res, m)
	}
	if err := rows.Err(); err != nil {
