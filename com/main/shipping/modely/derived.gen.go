...
func (m *FulfillmentExtended) __sqlSelect(w SQLWriter) {
	...
	w.WriteByte(',')
	core.WriteCols(w, string(__sqlFulfillmentExtended_JoinAs[2]), (*etop_vn_backend_com_main_moneytx_model.MoneyTransactionShipping)(nil).SQLListCols())
}
...
func (m *FulfillmentExtended) __sqlJoin(w SQLWriter, types []sq.JOIN_TYPE) {
	...
	w.WriteRawString(" JOIN ")
	w.WriteName((*etop_vn_backend_com_main_ordering_model.Order)(nil).SQLTableName())
	w.WriteRawString(" AS ")
	...
	w.WriteRawString(" JOIN ")
	w.WriteName((*etop_vn_backend_com_main_moneytx_model.MoneyTransactionShipping)(nil).SQLTableName())
	w.WriteRawString(" AS ")
...
func (m *FulfillmentExtended) SQLScanArgs(opts core.Opts) []interface{} {
	...
	m.MoneyTransactionShipping = new(etop_vn_backend_com_main_moneytx_model.MoneyTransactionShipping)
