...
func (ft *OrderFilters) ByFulfillmentType(FulfillmentType orderingtypes.ShippingType) *sq.ColumnFilter {
	return &sq.ColumnFilter{
		Prefix: &ft.prefix,
...
func (ft *OrderFilters) ByFulfillmentTypePtr(FulfillmentType *orderingtypes.ShippingType) *sq.ColumnFilterPtr {
	return &sq.ColumnFilterPtr{
		Prefix: &ft.prefix,
		Column: "fulfillment_type",
		Value:  FulfillmentType,
