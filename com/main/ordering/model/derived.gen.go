...
func (m *OrderHistory) SQLScan(opts core.Opts, row *sql.Row) error {
	data := make([]interface{}, 68)
	args := make([]interface{}, 68)
	for i := 0; i < 68; i++ {
		args[i] = &data[i]
	}
