...
import (
	...
	model "etop.vn/backend/com/main/identity/model"
...
func sqlgenCreditExtended(_ *CreditExtended, _ *Credit, as sq.AS, t0 sq.JOIN_TYPE, _ *model.Shop, a0 sq.AS, c0 string) bool {
...
func (m *CreditExtended) __sqlSelect(w SQLWriter) {
	...
	w.WriteByte(',')
	core.WriteCols(w, string(__sqlCreditExtended_JoinAs[0]), (*model.Shop)(nil).SQLListCols())
}
