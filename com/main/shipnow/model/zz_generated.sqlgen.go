...
func (m *ShipnowFulfillmentHistory) SQLScan(opts core.Opts, row *sql.Row) error {
	data := make([]interface{}, 44)
	args := make([]interface{}, 44)
	for i := 0; i < 44; i++ {
		args[i] = &data[i]
	}
	...
	res := make(ShipnowFulfillmentHistory, 44)
	res["id"] = data[0]
	res["shop_id"] = data[1]
