...
const __sqlPayment_ListColsOnConflict = "\"id\" = EXCLUDED.\"id\",\"data\" = EXCLUDED.\"data\",\"order_id\" = EXCLUDED.\"order_id\",\"payment_provider\" = EXCLUDED.\"payment_provider\",\"action\" = EXCLUDED.\"action\",\"created_at\" = EXCLUDED.\"created_at\",\"updated_at\" = EXCLUDED.\"updated_at\""
